...
const Button: React.FC<Props> = (props) => {
  ...
  return (
    <button 
      ...
      className={clsx(
        'font-semibold rounded-md outline-offset-2 focus:outline-2 focus:outline-primary-600 disabled:opacity-50',
        {
          'bg-primary-600 text-white hover:bg-primary-500': variant === 'filled',
