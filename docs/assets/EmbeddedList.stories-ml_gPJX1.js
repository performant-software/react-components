import{r as E,j as n}from"./iframe-CobmjQJx.js";import{B as R}from"./Button-Dbwe2y1K.js";import{i as u,C as j}from"./Movies-Drt9F137.js";import{I as N}from"./Icon-GUvrG6NX.js";import{_ as A}from"./index-default-B8-H6N8J.js";import{A as x}from"./AddModal-DSFYD1ms.js";import{E as P}from"./EditModal-BiRTD7Wu.js";import{T as _}from"./Table-2bQlPHxy.js";import{_ as c}from"./index-default-C0I3bBxV.js";import{D as M}from"./DataTable-iL1vw_Di.js";import{D as L}from"./Draggable-CA04ATQC.js";import{v as B}from"./v4-BKrj-4V8.js";import{T as S}from"./TabbedModal-DTtUjmwL.js";import{u as s}from"./DragDrop-DAv-fPdh.js";import"./extends-CCbyfPlC.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./getElementType-DIRvTXcE.js";import"./Label-BcJmCt3K.js";import"./ModernAutoControlledComponent-BY7sqkaA.js";import"./assertThisInitialized-B9jnkVVz.js";import"./includes-BzBOEv5Z.js";import"./toFinite-BcRf1gcc.js";import"./forEach-BqzC2Qd6.js";import"./Dimmer-B-_T9QPF.js";import"./Portal-DxbNXBbZ.js";import"./keyboardKey-CpnYesMy.js";import"./map-Be6cYnHc.js";import"./Modal-BihmrXEw.js";import"./index-BtclWLUu.js";import"./_baseSet-s3dmyMK_.js";import"./_baseAssignValue-vU6UmBOq.js";import"./_arrayReduce-CrxnWFSq.js";import"./isEmpty-Bshox7mM.js";import"./index-BEWOVopg.js";import"./index.es28-C7GyLKAW.js";import"./index.es3-DxE3ZTdP.js";import"./index.es33-DhNiIy8Z.js";import"./Message-CqyinnDI.js";import"./Loader-CWFBLCvq.js";import"./Toaster-CVu5fBSF.js";import"./Transition-Hcs1o03D.js";import"./filter-L5_Mefwz.js";import"./i18n-DkobdbHY.js";import"./i18next-eNuDfwAU.js";import"./Checkbox-oRHOQ6_f.js";import"./Popup-CONHw0H7.js";import"./createClass-CGi6Kyeu.js";import"./toPropertyKey-BdisF6oo.js";import"./Dropdown-D7LDOEs-.js";import"./without-CKwVA1rn.js";import"./isArrayLikeObject-2d3OUaSN.js";import"./deburr-DRAx_YPq.js";import"./DataList-D-SJPMV7.js";import"./index.es35-NGGuPWEW.js";import"./Input-DmEhvK3s.js";import"./List-BrB96U_v.js";import"./Confirm-Cy5w8bEv.js";import"./Pagination-u0emsjaJ.js";import"./_isIterateeCall-DasQde38.js";import"./Menu-D14R0e9t.js";import"./Grid-DLFjhpbj.js";import"./Header-Be1W_DdE.js";import"./DropdownButton-2muVNJFa.js";import"./index.es24-BxCSri79.js";import"./Form-bJjgXI2d.js";import"./AssociatedDropdown-GWEkO6eY.js";import"./FuzzyDate-BZbEO_Om.js";import"./DateInput-otOcw5dv.js";import"./Trans-i-hGYWSB.js";import"./context-C_8MqbTn.js";import"./useDrop-CxCV2w22.js";import"./index-D9Hk7Cc8.js";import"./index.es26--n2hyN59.js";import"./redux-1N3yOUoT.js";import"./objectSpread2-xTxB_n9c.js";import"./defineProperty-BhpcgfZc.js";const H=".",D="ascending",I="descending";class r extends E.Component{static defaultProps;constructor(e){super(e),this.state={sortColumn:null,sortDirection:null}}componentDidMount(){let e;this.props.defaultSort?e=c.findWhere(this.props.columns,{name:this.props.defaultSort}):e=c.find(this.props.columns,t=>t.sortable!==!1),e&&this.onColumnClick(e,this.props.defaultSortDirection)}getItems(){const{items:e}=this.props,{sortColumn:t,sortDirection:d}=this.state;return c.orderBy(c.filter(e,a=>!a._destroy),t,d)}onColumnClick(e,t=D){if(this.props.onDrag||e.sortable===!1)return;const d=e.name;let a=t||D;e.name===this.state.sortColumn&&(a=this.state.sortDirection===D?I:D),this.setState({sortColumn:d,sortDirection:a})}onDelete(e){return this.props.onDelete(e),Promise.resolve()}onSave(e){const t=e.uid?e.uid:B();return this.props.onSave&&this.props.onSave({...e,uid:t}),Promise.resolve()}render(){return n.jsx(M,{...this.props,actions:this.props.actions,addButton:this.props.addButton,buttons:this.props.buttons,className:`embedded-list ${this.props.className?this.props.className:""}`,configurable:this.props.configurable,columns:this.props.columns,count:this.props.items.length,items:this.getItems(),modal:this.props.modal,onColumnClick:this.onColumnClick.bind(this),onCopy:this.props.onCopy,onDrag:this.props.onDrag,onDelete:this.onDelete.bind(this),onSave:this.onSave.bind(this),renderDeleteModal:this.props.renderDeleteModal,renderEmptyRow:this.props.renderEmptyRow,renderItem:this.renderItem.bind(this),sortColumn:this.state.sortColumn,sortDirection:this.state.sortDirection,tableProps:{celled:!0,sortable:!this.props.onDrag,...this.props.tableProps||{}},selectable:this.props.selectable,onRowSelect:this.props.onRowSelect,selectedRows:this.props.selectedRows,showRecordCount:this.props.showRecordCount})}renderItem(e,t,d){if(this.props.onDrag){const a=e.id||e.uid;return n.jsx(L,{id:a,index:t,item:e,onDrag:this.props.onDrag.bind(this),children:n.jsx(_.Row,{children:d})},a)}return n.jsx(_.Row,{children:d},t)}}c.mixin({orderBy:(o,e,t)=>{if(!e)return o;const d=c.property(e.split(H));let a=c.sortBy(o,T=>d(T));return t===I&&(a=a.reverse()),a}});r.defaultProps={items:[],addButton:{location:"top"},buttons:[],className:"",configurable:!0,modal:void 0,onCopy:void 0,onDrag:void 0,onSave:()=>{},renderDeleteModal:void 0,renderEmptyRow:void 0};r.__docgenInfo={description:`The <code>EmbeddedList</code> component can be used to display a collection of records that live within a parent
