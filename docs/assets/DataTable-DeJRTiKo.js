var q=Object.defineProperty;var x=(m,l,e)=>l in m?q(m,l,{enumerable:!0,configurable:!0,writable:!0,value:e}):m[l]=e;var c=(m,l,e)=>(x(m,typeof l!="symbol"?l+"":l,e),e);import{j as a}from"./jsx-runtime-D9TvR9R2.js";import{r as p}from"./index-C0dDX-lL.js";import{o as f}from"./index.es34-tedbSeou.js";import{J as b}from"./index.es32-D5CmterR.js";import{T as i}from"./Table-tX4yfnvw.js";import{B as T}from"./Button-Dcib8V--.js";import{L as R}from"./Loader-DQkWekFb.js";import{C as w}from"./Checkbox-Bi1MrC0t.js";import{P as E}from"./Popup-ByI5AcCV.js";import{_ as o}from"./index-default-C_maRo4o.js";import{i as v}from"./i18n-C9xJ7SCg.js";import{I as S}from"./Icon-BGzIEILD.js";import{D as g}from"./Dropdown-CChVlGq2.js";import{D as j}from"./Draggable-DXdZIbN3.js";import{L as k}from"./ListSession-hS-NIzK1.js";import{u as P}from"./List-C_K1x0oV.js";import{R as A}from"./Portal-CKYxdKwP.js";const C=m=>a.jsx("div",{className:"column-resize",onMouseDown:m.onMouseDown.bind(void 0),role:"presentation",children:" "});C.__docgenInfo={description:"",methods:[],displayName:"ColumnResize",props:{onMouseDown:{required:!0,flowType:{name:"signature",type:"function",raw:"(e: MouseEvent) => void",signature:{arguments:[{name:"e",type:{name:"MouseEvent"}}],return:{name:"void"}}},description:""}}};const I=m=>{var l;return l=class extends p.Component{constructor(e){super(e),this.state=this.initializeState(e)}componentDidUpdate(e,n){b.isEqual(e.columns,this.props.columns)||this.setState({columns:this.props.columns}),b.isEqual(n.columns,this.state.columns)||this.setSession()}initializeState(e){const{key:n,storage:t}=e.session||{},r=k.restoreSession(n,t)||{};if(o.isEmpty(r.columns))return{columns:e.columns};const u=[];o.each(r.columns,s=>{const h=o.findWhere(e.columns,{name:s.name});h&&u.push({...h,...s})});const d=o.pluck(u,"name");return o.each(e.columns,s=>{o.contains(d,s.name)||u.push(s)}),{columns:u}}onColumnCheckbox(e){this.setState(n=>({columns:o.map(n.columns,t=>t.name===e.name?{...t,hidden:!t.hidden}:t)}))}onDrag(e,n){this.setState(t=>{const r=[],u=[];o.each(t.columns,(s,h)=>{s.label&&s.label.length?r.push(s):u.push({index:h,column:s})});const d=r[e];return r.splice(e,1),r.splice(n,0,d),o.each(u,s=>r.splice(s.index,0,s.column)),{columns:r}})}render(){return a.jsx(m,{...this.props,className:`data-table-column-selector ${this.props.className}`,columns:this.state.columns,renderListHeader:this.renderHeader.bind(this)})}renderHeader(){return this.props.configurable||this.props.renderListHeader?a.jsxs(a.Fragment,{children:[this.props.renderListHeader&&this.props.renderListHeader(),this.props.configurable&&a.jsx(g,{"aria-label":"Select Columns",basic:!0,button:!0,icon:"cog",className:"icon configure-button open-right",closeOnBlur:!1,children:a.jsx(g.Menu,{children:this.state.columns.filter(e=>e.label&&e.label.length).map((e,n)=>a.jsx(j,{id:e.name,index:n,onDrag:this.onDrag.bind(this),children:a.jsxs(g.Item,{"aria-dropeffect":"move",onClick:t=>t.stopPropagation(),children:[a.jsx(S,{name:"bars"}),a.jsx(w,{"aria-label":"Select Column",checked:!e.hidden,label:e.label,onClick:this.onColumnCheckbox.bind(this,e)})]})},e.name))})})]}):null}setSession(){const{key:e,storage:n}=this.props.session||{};if(!e)return;const t=o.map(this.state.columns,r=>o.pick(r,"name","hidden"));k.setSession(e,n,{columns:t})}},c(l,"defaultProps",{className:""}),l};class y extends p.Component{constructor(e){super(e);c(this,"columnRefs");c(this,"onClick");c(this,"onMouseMove");c(this,"onMouseUp");this.state={resize:null,activePanel:null},this.initializeColumnRefs(),this.onClick=this.onPreventClick.bind(this),this.onMouseMove=this.onColumnResize.bind(this),this.onMouseUp=this.afterColumnResize.bind(this)}afterColumnResize(){this.state.resize&&f.isBrowser()&&(document.addEventListener("click",this.onClick,!0),this.setState({resize:void 0}))}initializeColumnRefs(){this.columnRefs={},o.each(this.props.columns,e=>{this.columnRefs[e.name]=p.createRef()})}componentDidMount(){f.isBrowser()&&(document.addEventListener("mousemove",this.onMouseMove),document.addEventListener("mouseup",this.onMouseUp))}componentDidUpdate(e){b.isEqual(e.columns,this.props.columns)||this.initializeColumnRefs()}componentWillUnmount(){f.isBrowser()&&(document.removeEventListener("mousemove",this.onMouseMove),document.removeEventListener("mouseup",this.onMouseUp))}getColumnCount(){let e=this.props.columns.length;return this.props.actions&&this.props.actions.length&&(e+=1),e}onColumnResize(e){const{resize:n}=this.state;if(n){const{columnRef:t,offset:r}=n;t.current.style.width=`${r+e.pageX}px`}}onPreventClick(e){e.stopPropagation(),f.isBrowser()&&document.removeEventListener("click",this.onClick,!0)}onSelectAll(e){let n;e?n=[...this.props.items||[]]:n=o.reject(this.props.items,this.props.isRowSelected.bind(this)),o.each(n,this.props.onRowSelect&&this.props.onRowSelect.bind(this))}render(){return a.jsxs(i,{className:"data-table",...this.props.tableProps,children:[a.jsx(i.Header,{children:a.jsxs(i.Row,{children:[this.renderSelectHeader(),this.props.columns.map(this.renderHeaderCell.bind(this)),this.renderActionsHeader()]})}),a.jsxs(i.Body,{children:[this.props.items&&this.props.items.map(this.renderItem.bind(this)),this.renderEmptyTableRow(),this.renderLoading()]})]})}renderActionButton(e,n,t){if(t.render)return t.render(e,n);const{asProps:r=()=>({})}=t,u=p.createElement(T,{"aria-label":t.name,as:t.as,...r(e),basic:!0,compact:!0,color:t.color,icon:t.icon,key:`${t.name}-${n}`,onClick:t.onClick&&t.onClick.bind(this,e,n),title:t.title});if(t.popup){const{content:d,title:s}=t.popup;return a.jsx(E,{content:d,header:s,hideOnScroll:!0,mouseEnterDelay:500,position:"top right",trigger:u},`${t.name}-${n}`)}return u}renderActions(e,n){if(!(this.props.actions&&this.props.actions.length))return null;const t=this.props.actions.filter(r=>!r.accept||r.accept(e));return a.jsx(i.Cell,{className:"actions-cell",children:t.map(this.renderActionButton.bind(this,e,n))},n)}renderActionsHeader(){return this.props.actions&&this.props.actions.length?a.jsx(i.HeaderCell,{children:v.t("DataTable.columns.actions")}):null}renderCell(e,n){if(n.hidden)return null;let t;return n.render?t=n.render(e):n.resolve?t=n.resolve(e):t=e[n.name],a.jsx(i.Cell,{className:n.className,children:t},`${e.id}-${n.name}`)}renderEmptyTableRow(){return this.props.loading||this.props.items&&this.props.items.length?null:this.props.renderEmptyRow?this.props.renderEmptyRow():a.jsx(i.Row,{children:a.jsx(i.Cell,{colSpan:this.getColumnCount(),textAlign:"center",children:a.jsx("div",{className:"empty-container",children:this.props.renderEmptyMessage()})})})}renderHeaderCell(e){return e.hidden?null:e.renderHeader?e.renderHeader():a.jsx(A,{innerRef:this.columnRefs[e.name],children:a.jsxs(i.HeaderCell,{sorted:this.props.sortColumn===e.name?this.props.sortDirection:null,onClick:()=>this.props.onColumnClick(e),children:[e.label,a.jsx(C,{onMouseDown:n=>{const t=this.columnRefs[e.name],r=t.current.offsetWidth-n.pageX;this.setState({resize:{columnRef:t,offset:r}})}})]},e.name)},e.name)}renderItem(e,n){const t=[this.renderSelectCheckbox(e,n),this.props.columns.map(this.renderCell.bind(this,e)),this.renderActions(e,n)],r=u=>{u.target.nodeName==="TD"&&this.setState(d=>({activePanel:d.activePanel===e.id?"":e.id}))};return this.props.renderItem?this.props.renderItem(e,n,t):a.jsxs(p.Fragment,{children:[a.jsx(i.Row,{onClick:this.props.expandableRows?r:()=>{},className:this.props.expandableRows?"expandable":"",children:t}),this.props.expandableRows&&a.jsx(i.Row,{className:this.state.activePanel===e.id?"expanded-panel":"hidden",children:this.props.expandPanel&&this.props.expandPanel(e,this.state.activePanel)})]},n)}renderLoading(){return this.props.loading?a.jsx(i.Row,{children:a.jsx(i.Cell,{colSpan:this.getColumnCount(),textAlign:"center",children:a.jsx(R,{active:!0,content:v.t("DataTable.loading"),inline:!0})})}):null}renderSelectCheckbox(e,n){return this.props.selectable&&this.props.onRowSelect&&this.props.isRowSelected?a.jsx(i.Cell,{className:"select-cell",children:a.jsx(w,{onClick:this.props.onRowSelect.bind(this,e),checked:this.props.isRowSelected(e)})},`select-cell-${n}`):null}renderSelectHeader(){if(!this.props.selectable)return null;const e=!!(this.props.items&&this.props.items.length&&o.every(this.props.items,this.props.isRowSelected.bind(this)));return a.jsx(i.HeaderCell,{className:"select-cell",children:a.jsx(w,{onClick:this.onSelectAll.bind(this,e),checked:e})})}}c(y,"defaultProps");y.defaultProps={actions:void 0,addButton:{location:"top",color:"green"},buttons:[],count:0,className:"",csvExportButton:void 0,expandableRows:!1,expandPanel:void 0,filters:void 0,items:[],loading:!1,modal:void 0,page:1,pages:1,onColumnClick:()=>{},onCopy:void 0,onPageChange:()=>{},renderDeleteModal:void 0,renderEmptyRow:void 0,renderSearch:void 0,renderItem:void 0,showRecordCount:!1,sortColumn:void 0,sortDirection:void 0};const Q=I(P(y));y.__docgenInfo={description:"",methods:[{name:"afterColumnResize",docblock:`If the resize object is present on the state, sets the capture click handler on the document and
