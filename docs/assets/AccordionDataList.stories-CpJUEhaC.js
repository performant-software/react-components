import{r as l,j as t}from"./iframe-Cv6NyGmh.js";import{B as c}from"./Button-zdyej-Ns.js";import{_ as A}from"./index-default-B8-H6N8J.js";import{_ as d}from"./index-default-C0I3bBxV.js";import{C as x}from"./Checkbox-lB6HVmnk.js";import{D as L}from"./Dropdown-B50dAwHv.js";import{N as D}from"./NestedAccordion-ZOA57YJN.js";import{u as R,S as I}from"./DataList-BkNdESw3.js";import{u as j}from"./List-yzxA6hkM.js";import{A as b}from"./AddModal-bS42cZbd.js";import{A as v}from"./Api-DGMTLhRm.js";import"./extends-CCbyfPlC.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./getElementType-K35LTaJK.js";import"./Icon-D39B3oXB.js";import"./Label-PLpICGDf.js";import"./ModernAutoControlledComponent-CWIOmKmV.js";import"./assertThisInitialized-B9jnkVVz.js";import"./includes-CIqIAdm8.js";import"./toFinite-C3a1HOTY.js";import"./forEach-DYNAt1Hb.js";import"./Dimmer-CO3zZvZo.js";import"./Portal-ufNDYVit.js";import"./keyboardKey-Cd-j_P4w.js";import"./map-BUcwO8PI.js";import"./_baseSet-Dw2mDaci.js";import"./_baseAssignValue-DX0AaM9e.js";import"./without-DdnIuVqG.js";import"./isArrayLikeObject-Ce41-Z_2.js";import"./isEmpty-Bw_Vnau-.js";import"./deburr-CjsteLk7.js";import"./index-DoxK8g02.js";import"./_arrayReduce-CrxnWFSq.js";import"./filter-D9yOTXjS.js";import"./Accordion-CZDDO1S-.js";import"./index.es28-BrPO8HkR.js";import"./index.es33-DT5j-KBj.js";import"./index.es35-NGGuPWEW.js";import"./Message-MI48S3gU.js";import"./Input-DTpHfPup.js";import"./i18n-DkobdbHY.js";import"./i18next-eNuDfwAU.js";import"./Toaster-Dy4TVt-l.js";import"./Transition-DKqfiOPy.js";import"./v4-BKrj-4V8.js";import"./Confirm-DrCgkaAI.js";import"./Modal-DN1JnBhx.js";import"./index-s2ERkgXD.js";import"./Pagination-BuKyy3RL.js";import"./_isIterateeCall-Doo6nanL.js";import"./Menu-D6ShwTvo.js";import"./Grid-DSj0VIn4.js";import"./Header-DTn2EuHQ.js";import"./DropdownButton-Djerm2Sl.js";import"./EditModal-DR52Ceus.js";import"./index.es3-C2XTaclT.js";import"./Loader-CFgT3GZm.js";import"./index.es24-BxCSri79.js";import"./Form-CXlkfe8C.js";import"./AssociatedDropdown-yjiBNCsM.js";import"./FuzzyDate-B-9pz9lk.js";import"./DateInput-DZ8S2pwu.js";import"./Trans-BY6d2YaY.js";import"./context-BVASdw_k.js";const P=j(e=>{const o=l.useCallback(n=>{const s=d.filter(e.actions,r=>!r.accept||r.accept(n));return d.isEmpty(s)?null:t.jsx(c.Group,{children:d.map(s,(r,q)=>t.jsx(c,{"aria-label":r.name,basic:!0,color:r.color,icon:r.icon,onClick:r.onClick&&r.onClick.bind(void 0,n),title:r.title},`${r.name}-${q}`))})},[e.actions]),i=l.useCallback(n=>e.selectable?t.jsx(x,{className:"row-select-checkbox",onClick:(s,r)=>e.onRowSelect(r,n,s),checked:!!e.selectedRows.find(s=>s.id===n.id)},`select-checkbox-${n.id}`):null,[e.onRowSelect,e.selectable,e.selectedRows]);return t.jsx("div",{className:["accordion-data-list",e.className||""].join(" "),children:t.jsx(D,{getChildItems:e.getChildItems,onItemToggle:n=>e.onItemToggle&&e.onItemToggle(n),renderItem:n=>e.renderItem(n),renderRight:n=>t.jsxs(t.Fragment,{children:[o(n),i(n)]}),rootItems:e.rootItems,showToggle:n=>e.showToggle(n)})})}),S=e=>{const o=l.useMemo(()=>e.getRootItems(e.items),[e.items]),i=l.useCallback(a=>e.getChildItems(e.items,a),[e.items]),n=l.useRef(),s=l.useMemo(()=>{const a=d.find(e.sort,{value:e.sortColumn});return a&&a.text},[e.sort,e.sortColumn]),r=l.useCallback(a=>{if(!e.onSort)return;let u;a.value!==e.sortColumn&&(u=a.direction),e.onSort(a.value,u)},[e.onSort,e.sortColumn]),q=l.useCallback(()=>d.isEmpty(e.sort)?null:t.jsxs(c.Group,{basic:!0,style:{fontSize:"inherit"},children:[t.jsx(c,{"aria-label":"Sort by",content:s,icon:e.sortDirection===I?"sort alphabet up":"sort alphabet down",onClick:a=>n.current&&n.current.handleClick(a)}),t.jsx(L,{"aria-label":"Sort by toggle",className:"button icon",floating:!0,options:d.map(e.sort,a=>({...a,onClick:()=>r(a)})),ref:n,trigger:t.jsx(t.Fragment,{}),value:e.sortColumn})]}),[e.sort,e.sortColumn,e.sortDirection]);return l.useEffect(()=>{if(d.isEmpty(e.sort))return e.onInit();const{page:a}=e;let{sortColumn:u="",sortDirection:T=I}=e;if(!u){const C=d.first(e.sort);C&&(u=C.value,C.direction&&(T=C.direction))}return e.onSort(u,T,a)},[]),t.jsx(P,{...e,renderListHeader:q,rootItems:o,getChildItems:i})},p=R(S);S.__docgenInfo={description:"",methods:[],displayName:"AccordionDataList",props:{actions:{required:!1,flowType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
