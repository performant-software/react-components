import{r as a,j as n}from"./iframe-BLgZWRCp.js";import{_ as C}from"./index-default-B8-H6N8J.js";import{r as h,d as M,i as R,e as F,p as O}from"./index.es28-Rg3NxGAU.js";import{G as x}from"./Grid-C-f4-0co.js";import{M as $}from"./Message-CZD5qOx8.js";import{B as j}from"./Button-DBnOKBlt.js";import{L as k}from"./List-DV3pWQPS.js";import{_ as u}from"./index-default-C0I3bBxV.js";import{F as G}from"./Form-xCzzVPQ4.js";import{M as S}from"./Modal-DilQqFZR.js";import{i as v}from"./i18n-DkobdbHY.js";import{B as H}from"./BibliographyForm-CyG1-E7k.js";import{Z as V,B as Z}from"./BibliographySearchInput-C_x-ozu-.js";import{D as W}from"./Dropdown-B39ca9nf.js";import{S as z}from"./StyleSelector-FOFWXNkV.js";import{T as A}from"./Toaster-B1SOTNUV.js";import{u as J}from"./List-BbX6Zabl.js";import{v as X}from"./v4-BKrj-4V8.js";import"./extends-CCbyfPlC.js";import"./getElementType-1IYaeY7q.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./Icon-CxJFFl9I.js";import"./map-CWHsrrW0.js";import"./Label-CA5c1o9n.js";import"./ModernAutoControlledComponent-BNuszL3K.js";import"./assertThisInitialized-B9jnkVVz.js";import"./includes-U-4bWchp.js";import"./toFinite-B0zBBCYH.js";import"./forEach-B66pbtzg.js";import"./Dimmer-DQZjKlMb.js";import"./Portal-SWFjn5WJ.js";import"./keyboardKey-TMamj3A2.js";import"./Checkbox-BoNeAj1w.js";import"./_baseSet-Auq_ii7C.js";import"./_baseAssignValue-BYD9r0Sk.js";import"./Input-DA954Y-9.js";import"./index-C2wuau_u.js";import"./_arrayReduce-CrxnWFSq.js";import"./isEmpty-CV68PeRk.js";import"./index-DTmWq2QB.js";import"./i18next-eNuDfwAU.js";import"./Bibliography-CKUPMZyt.js";import"./without-hXNxFN8L.js";import"./isArrayLikeObject-qJU1iGYR.js";import"./deburr-CFKzU-xv.js";import"./filter-B61iGI06.js";import"./Transition-DF0hRvd-.js";import"./Confirm-BUYhCoqK.js";import"./Pagination-BryvuxTf.js";import"./_isIterateeCall-CEhk4L34.js";import"./Menu-Rgfapo_K.js";import"./Header-D9--OkAc.js";import"./DropdownButton-BYGuEiFX.js";import"./EditModal-CWT8Knaf.js";import"./index.es3-ChBtbScC.js";import"./index.es33-CNSQUi3t.js";import"./Loader-XmPepgwD.js";import"./AssociatedDropdown-DafMpsq6.js";import"./index.es35-NGGuPWEW.js";import"./FuzzyDate-Dz0ZhMXF.js";import"./DateInput-DbPp484u.js";import"./Trans-rWPveIkH.js";import"./context-B2wCj16Y.js";const Y=e=>{const[l,m]=a.useState(),r=a.useCallback(i=>{const o={...i};return h.isEmpty(o.title)&&h.isEmpty(o.creators)&&h.isEmpty(o.issue)&&h.extend(o,{title:M.t("Citation.labels.untitled")}),o},[]);return a.useEffect(()=>{if(e.locale&&e.style&&e.item){const{uid:i,...o}=e.item,c=new F({initialItems:[{key:i,...r(o)}],persist:!1}),s=h.first(c.itemsCSL),q={retrieveLocale:()=>e.locale,retrieveItem:()=>s},y=new O.Engine(q,e.style);y.updateItems([s.id]);const w=y.makeBibliography();m(h.last(w))}},[r,e.item,e.locale,e.style]),R.jsx("div",{dangerouslySetInnerHTML:{__html:l}})},B=e=>n.jsxs(S,{as:G,centered:!1,open:!0,children:[n.jsx(S.Header,{content:v.t("BibliographyModal.title")}),n.jsx(S.Content,{children:n.jsx(H,{...e})}),e.children]});B.__docgenInfo={description:"",methods:[],displayName:"BibliographyModal",props:{item:{required:!0,flowType:{name:"any"},description:""}}};const I="ascending",P="descending",_=e=>{const l=a.useRef(),m=a.useCallback(r=>{const i=e.value===r.value&&e.direction===I?P:I;e.onChange({...r,direction:i})},[e.direction,e.onChange,e.value]);return a.useEffect(()=>{if(!e.value){let r;e.defaultValue?r=u.findWhere(e.options,{value:e.defaultValue}):r=u.first(e.options),m(r)}},[]),n.jsxs(j.Group,{basic:!0,className:"sort-selector",style:{fontSize:"inherit"},children:[n.jsx(j,{"aria-label":"Sort by",content:e.text,icon:e.direction===I?"sort alphabet up":"sort alphabet down",onClick:r=>l.current.handleClick(r)}),n.jsx(W,{"aria-label":"Sort",className:"button icon",floating:!0,options:u.map(e.options,r=>({...r,onClick:()=>m(r)})),ref:l,trigger:n.jsx(n.Fragment,{}),value:e.value})]})};_.__docgenInfo={description:"",methods:[],displayName:"SortSelector",props:{defaultValue:{required:!1,flowType:{name:"string"},description:""},direction:{required:!0,flowType:{name:"string"},description:""},onChange:{required:!0,flowType:{name:"signature",type:"function",raw:"(sort: Sort) => void",signature:{arguments:[{name:"sort",type:{name:"intersection",raw:`Option & {
  direction?: string
