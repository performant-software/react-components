import{j as c}from"./jsx-runtime-D9TvR9R2.js";import{r as m}from"./index-C0dDX-lL.js";import{$ as k,a as p}from"./index-DsC2wsEy.js";import{c as u}from"./clsx-B-dksMZM.js";import{I as x}from"./Icon-BwuB1aie.js";import"./_commonjsHelpers-BosuxZz1.js";import"./extends-CCbyfPlC.js";import"./index-CIyLsbPd.js";import"./index-DOYXiIEK.js";import"./index-DwxJ7BsK.js";import"./index-BqvWSUer.js";const b=e=>c.jsx(k,{"aria-label":e.ariaLabel,checked:e.checked,className:"rounded-sm",disabled:e.disabled,id:e.id,onCheckedChange:e.onClick,children:c.jsx(p,{asChild:!0,forceMount:!0,children:c.jsx(x,{className:u({"fill-primary":e.checked},{"fill-black":!e.checked},{"hover:bg-white":!e.checked}),name:e.checked?"checkbox-filled":"checkbox"})})}),r=b;b.__docgenInfo={description:"",methods:[],displayName:"Checkbox",props:{ariaLabel:{required:!0,flowType:{name:"string"},description:"Label to show in the aria-label property for screen readers."},checked:{required:!0,flowType:{name:"boolean"},description:"Boolean state of the checkbox."},disabled:{required:!1,flowType:{name:"boolean"},description:"(Optional) Whether to disable the checkbox."},id:{required:!1,flowType:{name:"string"},description:"HTML ID to apply to the checkbox"},onClick:{required:!0,flowType:{name:"signature",type:"function",raw:"(arg: boolean) => any",signature:{arguments:[{name:"arg",type:{name:"boolean"}}],return:{name:"any"}}},description:`Callback that determines what to do when the checkbox is clicked.
@param {boolean} arg
