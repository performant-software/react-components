import{r,j as t}from"./iframe-FoyjJkLC.js";import"./index.es28-cvHwm1ao.js";import{T as g}from"./index.es12-BJ7LXKQD.js";import{R as y,T as x,a as k,P as w,b as j,c as C,d as N,C as q,A as T}from"./index-CU_rOJgb.js";import{c as i}from"./clsx-B-dksMZM.js";import{_ as o}from"./index-default-B8-H6N8J.js";import{C as p,a as V}from"./chevron-right-IRSyJG8z.js";const h=e=>{const[m,c]=r.useState(!1),[d,s]=r.useState(!1),{clearTimer:b,setTimer:u}=g();return r.useEffect(()=>{m&&(s(!0),b(),u(()=>s(!1)))},[e.value]),r.useEffect(()=>{m||c(!0)},[e.value]),t.jsx(w,{children:t.jsxs(j,{open:d,children:[t.jsx(C,{asChild:!0,children:t.jsx(N,{className:i("block h-5 w-5 rounded-full bg-gray-600","focus:outline-none focus-visible:ring focus-visible:ring-black focus-visible:ring-opacity-30",e.className),onFocus:()=>s(!0),onBlur:()=>s(!1),onMouseEnter:()=>s(!0),onMouseLeave:()=>s(!1)})}),t.jsxs(q,{side:e.position,sideOffset:5,children:[t.jsx("div",{className:"bg-white p-2 text-black rounded-md shadow-md shadow-gray-1000",children:e.value}),t.jsx(T,{className:"fill-white"})]})]})})};h.defaultProps={position:"top"};const v=r.forwardRef((e,m)=>{const{clearTimer:c,setTimer:d}=g(),s=r.useCallback(()=>{const[a,n]=e.value;let l=a-e.step;l<e.min&&(l=e.min),e.onValueChange([l,n]),e.onValueCommit&&(c(),d(()=>e.onValueCommit([l,n])))},[e.min,e.onValueChange,e.onValueCommit,e.step,e.value]),b=r.useCallback(()=>{const[a,n]=e.value;let l=n+e.step;l>e.max&&(l=e.max),e.onValueChange([a,l]),e.onValueCommit&&(c(),d(()=>e.onValueCommit([a,l])))},[e.max,e.onValueChange,e.onValueCommit,e.step,e.value]),u=r.useMemo(()=>e.actions?.filter(a=>!a.position||a.position==="bottom"),[e.actions]),f=r.useMemo(()=>e.actions?.filter(a=>a.position==="right"),[e.actions]);return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:i("flex","justify-between","items-center","pt-4",o.isEmpty(f)?"":"px-4",o.isEmpty(u)&&e.ticks?"pb-7":""),children:[!e.hideStepButtons&&t.jsx("button",{"aria-label":"Slider Left",className:i("px-3","py-3","disabled:opacity-50","disabled:hover:bg-transparent",e.classNames.button),onClick:s,type:"button",children:t.jsx(p,{})}),t.jsxs(y,{className:i("relative flex flex-grow h-5 touch-none items-center w-full",e.classNames.root),max:e.max,min:e.min,minStepsBetweenThumbs:1,onValueChange:e.onValueChange,onValueCommit:e.onValueCommit,ref:m,step:1,value:e.value,children:[t.jsx(x,{className:i("relative h-1 w-full grow bg-gray-100",e.classNames.track),children:t.jsx(k,{className:i("absolute h-full bg-gray-600",e.classNames.range)})}),e.ticks&&t.jsxs("svg",{className:"absolute mt-12 z-0 !overflow-visible",width:"100%",height:40,overflow:"visible",shapeRendering:"crispEdges",children:[o.map(e.ticks.major,({value:a,xOffset:n})=>t.jsxs("g",{transform:`translate(${n}, 0)`,children:[t.jsx("line",{y2:10,stroke:"currentColor"}),t.jsx("text",{className:"translate-y-8",style:{textAnchor:"middle"},fill:"currentColor",children:a},a)]},a)),o.map(e.ticks.minor,({value:a,xOffset:n})=>t.jsx("g",{transform:`translate(${n}, 0)`,children:t.jsx("line",{y2:5,stroke:"currentColor"})},a))]}),t.jsx(h,{className:e.classNames.thumb,position:e.position,value:e.value[0]}),t.jsx(h,{className:e.classNames.thumb,position:e.position,value:e.value[1]})]}),!e.hideStepButtons&&t.jsx("button",{"aria-label":"Slider Right",className:i("px-3","py-3","disabled:opacity-50","disabled:hover:bg-transparent",e.classNames.button),onClick:b,type:"button",children:t.jsx(V,{})}),!o.isEmpty(f)&&t.jsx("div",{className:i("flex justify-center items-center py-3 text-gray-600",e.classNames.reset),children:o.map(f,(a,n)=>t.jsx("button",{"aria-label":a.label,className:i("p-3","disabled:opacity-50","disabled:hover:bg-transparent",a.className),disabled:a.disabled,onClick:a.onClick,type:"button",children:a.icon},n))})]}),!e.ticks&&t.jsxs("div",{className:"flex justify-between w-full px-12",children:[t.jsx("div",{children:e.min}),t.jsx("div",{children:e.max})]}),!o.isEmpty(u)&&t.jsx("div",{className:i("flex justify-center items-center w-full py-3 text-gray-600",e.classNames.zoom),children:o.map(u,(a,n)=>t.jsx("button",{"aria-label":a.label,className:i("p-3","disabled:opacity-50","disabled:hover:bg-transparent",e.ticks?"mt-5":"",a.className),disabled:a.disabled,onClick:a.onClick,type:"button",children:a.icon},n))})]})});v.defaultProps={classNames:{},step:1,value:[]};v.__docgenInfo={description:"",methods:[],displayName:"FacetSlider",props:{actions:{required:!1,flowType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  /**
