import{j as o}from"./iframe-vd5jUnmh.js";import{I as i}from"./Icon-DvprR8oi.js";import{L as s}from"./Label-D1PIeSX5.js";import{_ as c}from"./index-default-C0I3bBxV.js";import"./extends-CCbyfPlC.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./getElementType-Dbrg5pYk.js";import"./ModernAutoControlledComponent-QVsiK7km.js";import"./assertThisInitialized-B9jnkVVz.js";import"./includes-eGroWB-Q.js";import"./toFinite-CzVf2XkS.js";import"./forEach-CbH1wg7D.js";import"./Dimmer-Fz-z8WIU.js";import"./Portal-C6ILt24N.js";import"./keyboardKey-DeBoM4Ub.js";const t=e=>o.jsx("div",{className:"tags-list",children:c.map(e.tags||[],n=>o.jsxs(s,{style:{backgroundColor:e.config&&e.config[n]&&e.config[n].background,color:e.config&&e.config[n]&&e.config[n].color,marginRight:"10px"},children:[n,e.onDelete&&o.jsx(i,{name:"delete",onClick:e.onDelete.bind(void 0,n)})]}))});t.__docgenInfo={description:"",methods:[],displayName:"TagsList",props:{config:{required:!1,flowType:{name:"signature",type:"object",raw:`{
  [key: string]: {
    background: string,
    color: string
  }
