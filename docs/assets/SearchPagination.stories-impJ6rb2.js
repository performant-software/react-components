import{r as i,j as s}from"./iframe-gJjXuBGV.js";import{P as l}from"./Pagination-JX92Bfzd.js";import"./extends-CCbyfPlC.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./map-DzenaboV.js";import"./getElementType-rS5bWeP6.js";import"./_getPrototype-dFVwFHqx.js";import"./ModernAutoControlledComponent-CNYE1dRd.js";import"./assertThisInitialized-B9jnkVVz.js";import"./_isIterateeCall-CnbN5PRK.js";import"./toFinite-Dfj0KU41.js";import"./toNumber-DIkYOhwr.js";import"./Menu-IjbUK-ju.js";import"./_arrayReduce-CrxnWFSq.js";import"./deburr-C0BqVWL7.js";import"./Icon-D9WoHwnx.js";import"./keyboardKey-DQq2vlf6.js";const r=({usePagination:o,...e})=>{const{currentRefinement:a,nbPages:u,refine:m}=o(e),p=i.useCallback((d,{activePage:c})=>m(c-1),[m]);return i.useEffect(()=>{e.scrollToTop&&window.scroll({top:0,behavior:"smooth"})},[a,e.scrollToTop]),u===0?null:s.jsx(l,{activePage:a+1,onPageChange:p,totalPages:u})};r.defaultProps={scrollToTop:!1};r.__docgenInfo={description:"This component is used with the `usePagination` hook from Instant Search Hooks and renders a list of page numbers\nthat can be selected by the user. If the `scrollToTop` prop is set to `true`, the window will scroll to the top\nafter applying a new value.",methods:[],displayName:"SearchPagination",props:{usePagination:{required:!0,flowType:{name:"signature",type:"function",raw:`(props: any) => ({
