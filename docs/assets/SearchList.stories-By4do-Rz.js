import{j as n}from"./jsx-runtime-D9TvR9R2.js";import{a as d}from"./chunk-WFFRPTHA-B2vgThZf.js";import"./index-C0dDX-lL.js";import{c as P}from"./clsx-B-dksMZM.js";import{I as q}from"./Icon-BwuB1aie.js";import{i as u}from"./i18n-Dq59_p0o.js";import{h as U}from"./Places-OKF0EhYG.js";import{s as O}from"./Array-DQ2fdePu.js";import"./preview-errors-CzpZmerH.js";import"./index-CKJfshIT.js";import"./v4-D8aEg3BZ.js";import"./_commonjsHelpers-BosuxZz1.js";import"./i18next-WuGp4vR6.js";import"./toPropertyKey-BcUJYDQU.js";import"./defineProperty-DcNpp85p.js";import"./classCallCheck-BNzALLS0.js";import"./createClass-BA4CoEfY.js";import"./inherits-DQ5KX8TJ.js";import"./assertThisInitialized-B9jnkVVz.js";import"./setPrototypeOf-DgZC2w_0.js";import"./getPrototypeOf-BYVhAdwF.js";const E=e=>e.onClick?n.jsx("button",{className:"w-full border-0 text-left",onClick:()=>e.onClick(e.item),type:"button",children:e.children}):e.children,A=e=>n.jsx(E,{...e,children:n.jsxs("li",{className:"py-3 px-6",onPointerEnter:e.onPointerEnter?()=>e.onPointerEnter(e.item):void 0,onPointerLeave:e.onPointerLeave?()=>e.onPointerLeave(e.item):void 0,children:[n.jsx("p",{className:"font-bold text-neutral-800",children:e.title}),e.attributes&&e.attributes.length>0&&n.jsx("ul",{className:"list-none",children:e.attributes.slice(0,3).map(t=>n.jsxs("li",{className:"text-sm text-neutral-800 flex gap-2 items-center list-none pl-5 pt-1",children:[n.jsx(q,{className:"min-w-[13px]",name:t.icon||"bullet",size:13}),t.render?t.render(e.item):e.item[t.name]]},t.name))})]})});A.__docgenInfo={description:"",methods:[],displayName:"SearchListItem",props:{attributes:{required:!1,flowType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  </div>`,...(h=(y=r.parameters)==null?void 0:y.docs)==null?void 0:h.source}}};var g,b,f;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:`() => <div className='h-[600px] w-[360px]'>
    <SearchList attributes={[{
    label: 'UUID',
    name: 'uuid'
  }, {
  ...
  </div>`,...(f=(b=o.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};var v,x,w;s.parameters={...s.parameters,docs:{...(v=s.parameters)==null?void 0:v.docs,source:{originalSource:`() => <div className='h-[600px] w-[360px]'>
    <SearchList attributes={[{
    label: 'UUID',
    name: 'uuid'
  }, {
  ...
  </div>`,...(j=(S=c.parameters)==null?void 0:S.docs)==null?void 0:j.source}}};const se=["Default","TitleCallback","OneResult","NoAttributes","EventHandlers","CustomStyles"];export{c as CustomStyles,r as Default,l as EventHandlers,m as NoAttributes,s as OneResult,o as TitleCallback,se as __namedExportsOrder,oe as default};
