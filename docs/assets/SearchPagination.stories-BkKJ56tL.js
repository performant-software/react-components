import{r as i,j as s}from"./iframe-DGeuXaOs.js";import{P as l}from"./Pagination-Co70tNRm.js";import"./extends-CCbyfPlC.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./map-EWkZVQRl.js";import"./getElementType-BXOZMkBo.js";import"./_getPrototype-dFVwFHqx.js";import"./ModernAutoControlledComponent-DzNbRDu3.js";import"./assertThisInitialized-B9jnkVVz.js";import"./_isIterateeCall-CnbN5PRK.js";import"./toFinite-Dfj0KU41.js";import"./toNumber-DIkYOhwr.js";import"./Menu-Bhla-1HH.js";import"./_arrayReduce-CrxnWFSq.js";import"./deburr-nhwr0qbt.js";import"./Icon-B47Gj_wn.js";import"./keyboardKey-ClhdZcHf.js";const r=({usePagination:o,...e})=>{const{currentRefinement:a,nbPages:u,refine:m}=o(e),p=i.useCallback((d,{activePage:c})=>m(c-1),[m]);return i.useEffect(()=>{e.scrollToTop&&window.scroll({top:0,behavior:"smooth"})},[a,e.scrollToTop]),u===0?null:s.jsx(l,{activePage:a+1,onPageChange:p,totalPages:u})};r.defaultProps={scrollToTop:!1};r.__docgenInfo={description:"This component is used with the `usePagination` hook from Instant Search Hooks and renders a list of page numbers\nthat can be selected by the user. If the `scrollToTop` prop is set to `true`, the window will scroll to the top\nafter applying a new value.",methods:[],displayName:"SearchPagination",props:{usePagination:{required:!0,flowType:{name:"signature",type:"function",raw:`(props: any) => ({
