import{j as e}from"./iframe-CobmjQJx.js";import{_ as p}from"./index-default-B8-H6N8J.js";import{R as i}from"./RelatedOrganizations-DOR-NuGK.js";import{b as d}from"./CoreData-BdrRbu6T.js";import{w as c}from"./CoreDataContextProvider-DiNTDej0.js";import"./RelatedList-BGIwTxBV.js";import"./clsx-B-dksMZM.js";import"./LoadAnimation-5g9B4y1e.js";import"./createLucideIcon-Bjbe7hnm.js";const S={title:"Components/Core Data/RelatedOrganizations",component:i},o=c(()=>{const a=d();return e.jsx(i,{onLoad:r=>a.fetchRelatedOrganizations("1",r)})}),t=c(()=>{const a=d();return e.jsx(i,{onLoad:r=>a.fetchRelatedOrganizations("1",r),renderItem:r=>e.jsxs("p",{children:[`${r.name}:`," ",Math.random()>.5?e.jsx("span",{style:{color:"green"},children:"↑"}):e.jsx("span",{style:{color:"red"},children:"↓"}),e.jsx("strong",{children:`$${(Math.random()*100).toPrecision(4)}`})]})})}),s=c(()=>e.jsx(i,{emptyMessage:"No related organizations",onLoad:()=>Promise.resolve()})),n=c(()=>{const a=d();return e.jsx(i,{moreLabel:"Load More",onLoad:r=>a.fetchRelatedOrganizations("1",r).then(m=>(p.extend(m.list,{count:22,pages:5}),m))})});o.__docgenInfo={description:"",methods:[],displayName:"Default"};t.__docgenInfo={description:"",methods:[],displayName:"CustomRender"};s.__docgenInfo={description:"",methods:[],displayName:"EmptyList"};n.__docgenInfo={description:"",methods:[],displayName:"Pagination"};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`withCoreDataContextProvider(() => {
