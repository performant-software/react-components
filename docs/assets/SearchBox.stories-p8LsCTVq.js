import{r as a,j as s}from"./iframe-0kzOYbDl.js";import"./index.es28-B-JgmnHx.js";import{o as f}from"./index.es35-NGGuPWEW.js";import{I as q}from"./Icon-DJJMCTRL.js";import{I as B}from"./Input-CHH5G1-n.js";import{_ as y}from"./index-default-C0I3bBxV.js";import"./extends-CCbyfPlC.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./getElementType-F4BGMwza.js";import"./includes-Bc-ZWqwy.js";import"./toFinite-BrzBV7X5.js";import"./map-CCTlyAeB.js";import"./Label-yTVPsSkO.js";import"./ModernAutoControlledComponent-D9Qz_mdq.js";import"./assertThisInitialized-B9jnkVVz.js";import"./forEach-Ccrb3wYW.js";import"./Dimmer-DhIieFQ_.js";import"./Portal-TP5vWZSH.js";import"./keyboardKey-BpJXLMj5.js";import"./Button-BZG2A5sY.js";const i=({useSearchBox:u,...e})=>{const{query:r,refine:p,clear:d,isSearchStalled:g}=u(e),[l,S]=a.useState(r),h=a.useRef(),x=a.useCallback(()=>{S(""),d();const{current:m}=h;m&&m.focus()},[d]),v=a.useCallback(()=>p(l),[p,l]);return s.jsx(B,{...e,"aria-label":"Search",icon:s.jsx(q,{link:!y.isEmpty(r),name:y.isEmpty(r)?"search":"times",onClick:x}),input:{"aria-label":"search"},loading:g,onChange:(m,{value:_})=>S(_),onKeyDown:()=>f.clearSearchTimer(),onKeyUp:()=>f.setSearchTimer(v),ref:h,type:"text",value:l})};i.__docgenInfo={description:"This component is used with the `useSearchBox` function from Instant Search Hooks and renders an input element that\nwhen changed will execute a new query.",methods:[],displayName:"SearchBox",props:{useSearchBox:{required:!0,flowType:{name:"signature",type:"function",raw:`(props: any) => ({
  query: string,
