import{r as i,j as s}from"./iframe-CDKtSUh7.js";import{P as l}from"./Pagination-CFzpAccx.js";import"./extends-CCbyfPlC.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./map-2oQ1uFDN.js";import"./getElementType-0Tp31rtT.js";import"./ModernAutoControlledComponent-B-ilQLgm.js";import"./assertThisInitialized-B9jnkVVz.js";import"./_isIterateeCall-3o-3Rpw-.js";import"./toFinite-DjjXQZ2l.js";import"./Menu-B8QB41J9.js";import"./_arrayReduce-CrxnWFSq.js";import"./deburr-hJjWoWgP.js";import"./Icon-5o84n6La.js";import"./keyboardKey-BIrml5XW.js";const r=({usePagination:o,...e})=>{const{currentRefinement:a,nbPages:u,refine:m}=o(e),p=i.useCallback((d,{activePage:c})=>m(c-1),[m]);return i.useEffect(()=>{e.scrollToTop&&window.scroll({top:0,behavior:"smooth"})},[a,e.scrollToTop]),u===0?null:s.jsx(l,{activePage:a+1,onPageChange:p,totalPages:u})};r.defaultProps={scrollToTop:!1};r.__docgenInfo={description:"This component is used with the `usePagination` hook from Instant Search Hooks and renders a list of page numbers\nthat can be selected by the user. If the `scrollToTop` prop is set to `true`, the window will scroll to the top\nafter applying a new value.",methods:[],displayName:"SearchPagination",props:{usePagination:{required:!0,flowType:{name:"signature",type:"function",raw:`(props: any) => ({
