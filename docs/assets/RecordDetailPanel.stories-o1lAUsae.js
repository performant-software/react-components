import{r as a,j as e}from"./iframe-9irgAvQM.js";import{_ as T}from"./index-default-B8-H6N8J.js";import{K as C}from"./KeyValueList-Ch4PNHkU.js";import{c as u}from"./clsx-B-dksMZM.js";import{A as J}from"./AccordionItemsList-D74QLIdo.js";import{I as U}from"./Icon-BaUqyAGY.js";import{L}from"./LoadAnimation-Bt291pVY.js";import{R as B}from"./RecordDetailBreadcrumbs-CuUWtzOy.js";import{B as E}from"./Button-V3tMHatW.js";import{i as D}from"./i18n-DmKDVPrF.js";import{R as O}from"./RecordDetailItem-Cgl4Rm5x.js";import{R as V}from"./RecordDetailHeader-Ci0pPp4m.js";import"./index-Cz8s3a3I.js";import"./extends-CCbyfPlC.js";import"./index-BuMB821E.js";import"./index-BME65hY4.js";import"./index-DLzTgCiP.js";import"./toPropertyKey-BdisF6oo.js";import"./defineProperty-BhpcgfZc.js";import"./inherits-DDprkOLY.js";import"./assertThisInitialized-B9jnkVVz.js";import"./setPrototypeOf-DgZC2w_0.js";import"./createClass-CGi6Kyeu.js";import"./RecordDetailTitle-hKUucbr0.js";const Q=i=>{const[s,l]=a.useState(!1),[c,R]=a.useState(!1),[P,W]=a.useState(0),[I,_]=a.useState(0),k=a.useRef(null),A=a.useMemo(()=>new ResizeObserver(n=>{const{target:S}=n[0];W(S.scrollHeight),_(S.clientHeight)}),[]),M=a.useCallback(n=>{n?(k.current=n,A.observe(n)):k.current=null},[A]);return a.useEffect(()=>{k.current&&R(P>I||s)},[P,I]),a.useEffect(()=>{l(!1)},[i.children,i.items]),a.useEffect(()=>()=>A.disconnect(),[]),e.jsxs("div",{className:i.classNames?.root,children:[e.jsxs("div",{className:u("flex","flex-col","relative",{"max-h-[250px]":!s}),children:[e.jsxs("div",{className:"overflow-hidden",ref:M,children:[e.jsx("ul",{className:i.classNames?.items,children:T.map(i.items,(n,S)=>e.jsx(O,{className:n.className,icon:n.icon,text:n.text},S))}),i.children]}),c&&!s&&e.jsx("div",{className:"absolute left-0 bottom-0 w-full h-[50px] bg-gradient-to-b from-white/50 to-white/100"})]}),c&&e.jsx(E,{className:"w-full justify-center mb-4",onClick:()=>l(n=>!n),rounded:!0,children:s?D.t("RecordDetailHeader.showLess"):D.t("RecordDetailHeader.showMore")})]})};Q.__docgenInfo={description:"",methods:[],displayName:"RecordDetailContent",props:{children:{required:!1,flowType:{name:"Node"},description:""},classNames:{required:!1,flowType:{name:"signature",type:"object",raw:`{
  root?: string,
  items?: string
