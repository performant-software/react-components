import{j as e,r as y}from"./iframe-CDKtSUh7.js";import{B as x}from"./Button-DA_XBQbJ.js";import{M as T}from"./Modal-BdRM98xc.js";import{C as a}from"./Card-DoV0yiLK.js";import{I as o}from"./Item-N8A5Iriz.js";import{_ as S}from"./index-default-B8-H6N8J.js";import{i as s}from"./test-image-BGrKnxUR.js";import{F as E}from"./FileInputButton-BCox8kNB.js";import{L as r}from"./LazyVideo-CbmMcDAg.js";import{p as _}from"./portrait-test-image-CFX7vfGN.js";import{v as t}from"./SampleVideo-Bq74ahmY.js";import"./extends-CCbyfPlC.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./getElementType-0Tp31rtT.js";import"./Icon-5o84n6La.js";import"./Label-CH_WshmF.js";import"./ModernAutoControlledComponent-B-ilQLgm.js";import"./assertThisInitialized-B9jnkVVz.js";import"./includes-DtwzgLcn.js";import"./toFinite-DjjXQZ2l.js";import"./forEach-Dp4nfTUu.js";import"./Dimmer-DQCDOJdA.js";import"./Portal-DdFmWNdd.js";import"./keyboardKey-BIrml5XW.js";import"./map-2oQ1uFDN.js";import"./index-Cv6_bv5M.js";import"./_baseSet-DuVMIhyb.js";import"./_baseAssignValue-U8vnLISS.js";import"./_arrayReduce-CrxnWFSq.js";import"./isEmpty-406wiN_k.js";import"./index-iiIS-OyD.js";import"./LazyLoader-D_W4uTQ8.js";import"./without-3MOHujL6.js";import"./isArrayLikeObject-DSQPvB88.js";import"./Loader-C2mCF20R.js";import"./Segment-uBrXrcS5.js";import"./Transition-D_S4Ilus.js";import"./filter-D_0iK0Hx.js";import"./i18n-DkobdbHY.js";import"./i18next-eNuDfwAU.js";import"./DownloadButton-QCjMOXI5.js";import"./v4-BKrj-4V8.js";import"./VideoPlayer-DMxORhkY.js";import"./index.es28-Db5bh1d3.js";import"./Message-BTfjGsMG.js";import"./index-default-C0I3bBxV.js";const{action:f}=__STORYBOOK_MODULE_ACTIONS__,Te={title:"Components/Semantic UI/LazyVideo"},n=()=>e.jsx(r,{image:{alt:"Test Image"},preview:s,src:t}),i=()=>e.jsx(r,{}),d=()=>e.jsxs(r,{image:{alt:"Test Image"},preview:s,src:t,children:[e.jsx(x,{color:"green",content:"Edit video",icon:"edit",onClick:f("edit")}),e.jsx(x,{color:"orange",content:"Change video",icon:"move",onClick:f("change")}),e.jsx(x,{color:"red",content:"Delete video",icon:"trash",onClick:f("delete")})]}),m=()=>{const[C,w]=y.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsx(r,{image:{alt:"Test Image"},preview:s,src:t,children:e.jsx(x,{color:"green",content:"Edit video",icon:"edit",onClick:()=>w(!0)})}),C&&e.jsxs(T,{open:!0,children:[e.jsx(T.Header,{children:"Edit video"}),e.jsx(T.Content,{children:"Edit"}),e.jsx(T.Actions,{children:e.jsx(x,{content:"Close",onClick:()=>w(!1)})})]})]})},c=()=>e.jsxs(a.Group,{children:[e.jsxs(a,{children:[e.jsx(r,{image:{alt:"First Image"},preview:s,src:t}),e.jsx(a.Content,{header:"Test 1"})]}),e.jsxs(a,{children:[e.jsx(r,{image:{alt:"Portrait Image"},preview:_,src:t}),e.jsx(a.Content,{header:"Test 2"})]}),e.jsxs(a,{children:[e.jsx(r,{image:{alt:"Third Image"},src:t}),e.jsx(a.Content,{header:"Test 3"})]}),e.jsxs(a,{children:[e.jsx(r,{}),e.jsx(a.Content,{header:"Test 4"})]})]}),p=()=>e.jsxs(o.Group,{children:[e.jsxs(o,{children:[e.jsx(o.Image,{children:e.jsx(r,{image:{alt:"First Image"},preview:s,src:t})}),e.jsx(o.Content,{header:"Test 1"})]}),e.jsxs(o,{children:[e.jsx(o.Image,{children:e.jsx(r,{image:{alt:"Portrait Image"},preview:_,src:t})}),e.jsx(o.Content,{header:"Test 2"})]}),e.jsxs(o,{children:[e.jsx(o.Image,{children:e.jsx(r,{image:{alt:"Third Image"},src:t})}),e.jsx(o.Content,{header:"Test 3"})]}),e.jsxs(o,{children:[e.jsx(o.Image,{children:e.jsx(r,{})}),e.jsx(o.Content,{header:"Test 4"})]})]}),l=()=>e.jsx(r,{image:{alt:"YouTube Image"},embedded:!0,preview:"http://img.youtube.com/vi/YXiZ8OsS3kk/0.jpg",src:"https://www.youtube.com/embed/YXiZ8OsS3kk"}),g=()=>{const[C,w]=y.useState();return e.jsx(e.Fragment,{children:e.jsx(r,{src:C&&URL.createObjectURL(C),children:e.jsx(E,{content:"Upload",icon:"file outline",onSelection:L=>w(S.first(L))})})})},u=()=>e.jsx(r,{image:{alt:"Test Image"},preview:"/path/to/preview.jpg",src:t}),I=()=>e.jsx(r,{image:{alt:"Test Image"},preview:s,src:"/path/to/source.mp4"}),h=()=>e.jsx(r,{image:{alt:"Test Image"},preview:"/path/to/preview.jpg",src:"/path/to/source.mp4"}),v=()=>e.jsx(r,{download:t,image:{alt:"Test Image"},name:"Video.mp4",preview:s,src:t}),j=()=>e.jsx(r,{image:{alt:"Test Image"},preview:s,src:t,transcriptions:[{label:"English",language:"en",src:"/src/assets/test.vtt"}]});n.__docgenInfo={description:"",methods:[],displayName:"Default"};i.__docgenInfo={description:"",methods:[],displayName:"Placeholder"};d.__docgenInfo={description:"",methods:[],displayName:"ExtraButtons"};m.__docgenInfo={description:"",methods:[],displayName:"onBlur"};c.__docgenInfo={description:"",methods:[],displayName:"CardContent"};p.__docgenInfo={description:"",methods:[],displayName:"ListContent"};l.__docgenInfo={description:"",methods:[],displayName:"Embedded"};g.__docgenInfo={description:"",methods:[],displayName:"Upload"};u.__docgenInfo={description:"",methods:[],displayName:"ErrorPreview"};I.__docgenInfo={description:"",methods:[],displayName:"ErrorSource"};h.__docgenInfo={description:"",methods:[],displayName:"ErrorPreviewAndSource"};v.__docgenInfo={description:"",methods:[],displayName:"Downloadable"};j.__docgenInfo={description:"",methods:[],displayName:"Transcriptions"};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`() => <LazyVideo image={{
  alt: 'Test Image'
}} preview={image} src={video} />`,...n.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => <LazyVideo />",...i.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`() => <LazyVideo image={{
  alt: 'Test Image'
  ...
  </LazyVideo>`,...d.parameters?.docs?.source}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`() => {
...
}`,...m.parameters?.docs?.source}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`() => <Card.Group>
    <Card>
      <LazyVideo image={{
      alt: 'First Image'
    }} preview={image} src={video} />
...
}]} />`,...j.parameters?.docs?.source}}};const fe=["Default","Placeholder","ExtraButtons","onBlur","CardContent","ListContent","Embedded","Upload","ErrorPreview","ErrorSource","ErrorPreviewAndSource","Downloadable","Transcriptions"];export{c as CardContent,n as Default,v as Downloadable,l as Embedded,u as ErrorPreview,h as ErrorPreviewAndSource,I as ErrorSource,d as ExtraButtons,p as ListContent,i as Placeholder,j as Transcriptions,g as Upload,fe as __namedExportsOrder,Te as default,m as onBlur};
