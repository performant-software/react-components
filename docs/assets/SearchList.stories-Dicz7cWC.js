import{j as t}from"./jsx-runtime-D9TvR9R2.js";import{a as f}from"./chunk-WFFRPTHA-B2vgThZf.js";import{r as s}from"./index-C0dDX-lL.js";import{c as J}from"./clsx-B-dksMZM.js";import{g as te}from"./index.es33-BQgRPptb.js";import{I as ne}from"./Icon-xn5eBWjd.js";import{i as x}from"./i18n-O47xwIR-.js";import{h as K}from"./Places-OKF0EhYG.js";import{s as Q}from"./Array-DQ2fdePu.js";import"./preview-errors-CzpZmerH.js";import"./index-CKJfshIT.js";import"./v4-D8aEg3BZ.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-DOYXiIEK.js";import"./iframe-DYe3U3eT.js";import"../sb-preview/runtime.js";import"./i18next-CwS9wMM1.js";import"./toPropertyKey-BcUJYDQU.js";import"./defineProperty-DcNpp85p.js";import"./inherits-CWPG5jll.js";import"./assertThisInitialized-B9jnkVVz.js";import"./setPrototypeOf-DgZC2w_0.js";import"./createClass-CV9nCQMI.js";import"./getPrototypeOf-BYVhAdwF.js";const ie=e=>e.onClick?t.jsx("button",{className:"w-full border-0 text-left hover:bg-transparent",onClick:()=>e.onClick(e.item),type:"button",children:e.children}):e.children,X=e=>{const o=s.useMemo(()=>e.attributes.slice(0,3).map(n=>n.render?n.render(e.item):e.item[n.name]),[e.attributes,e.item]);return t.jsx("div",{className:J({"bg-primary/20":e.isHighlight},{"hover:bg-primary/20":!!e.onClick}),children:t.jsx(ie,{...e,children:t.jsxs("div",{className:"py-3 px-4",onPointerEnter:e.onPointerEnter?()=>e.onPointerEnter(e.item):void 0,onPointerLeave:e.onPointerLeave?()=>e.onPointerLeave(e.item):void 0,children:[t.jsx("p",{className:"font-bold text-neutral-800",children:e.title}),e.attributes&&o.some(Boolean)&&t.jsx("ul",{className:"list-none",children:e.attributes.slice(0,3).map((n,m)=>t.jsx(t.Fragment,{children:!!o[m]&&t.jsxs("li",{className:"text-sm text-neutral-800 flex gap-2 items-center list-none pl-5 pt-1",children:[t.jsx(ne,{className:"min-w-[13px]",name:n.icon||"bullet",size:13}),o[m]]},n.name)}))})]})})})};X.__docgenInfo={description:"",methods:[],displayName:"SearchListItem",props:{attributes:{required:!1,flowType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  </div>`,...(U=($=h.parameters)==null?void 0:$.docs)==null?void 0:U.source}}};var q,P,R;p.parameters={...p.parameters,docs:{...(q=p.parameters)==null?void 0:q.docs,source:{originalSource:`() => <div className='h-[600px] w-[360px]'>
    <SearchList attributes={[{
    label: 'UUID',
    name: 'uuid'
  }, {
  ...
  </div>`,...(R=(P=p.parameters)==null?void 0:P.docs)==null?void 0:R.source}}};var H,E,F;g.parameters={...g.parameters,docs:{...(H=g.parameters)==null?void 0:H.docs,source:{originalSource:`() => <div className='h-[600px] w-[360px]'>
    <SearchList attributes={[{
    label: 'UUID',
    name: 'uuid'
  }, {
