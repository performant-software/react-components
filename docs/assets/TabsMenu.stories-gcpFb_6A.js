import{j as t}from"./iframe-C1yIdUxi.js";import{M as a}from"./Menu-C8BjwoVA.js";import{_ as n}from"./index-default-C0I3bBxV.js";import"./extends-CCbyfPlC.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./map-DI4b9sYh.js";import"./getElementType-DsntGQ7s.js";import"./ModernAutoControlledComponent-Br5d4aPK.js";import"./assertThisInitialized-B9jnkVVz.js";import"./_arrayReduce-CrxnWFSq.js";import"./deburr-CsC_e8aR.js";import"./Icon-DP6yU2re.js";const s=i=>t.jsx(a,{pointing:!0,secondary:!0,children:n.map(n.where(i.tabs,{visible:!0}),r=>t.jsx(a.Item,{active:r.active,name:r.label,onClick:i.onTabClick.bind(void 0,r)},r.key))});s.__docgenInfo={description:"",methods:[],displayName:"TabsMenu",props:{onTabClick:{required:!0,flowType:{name:"signature",type:"function",raw:"(tab: Tab) => void",signature:{arguments:[{name:"tab",type:{name:"signature",type:"object",raw:`{
  active: boolean,
  key: string,
  label: string,
  visible: boolean
