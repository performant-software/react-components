import{r as l,j as e}from"./iframe-vd5jUnmh.js";import{F as d}from"./Form-Db_2OMnV.js";import{E as h,A as y}from"./english-BQymWagN.js";import{y as f}from"./index.es28-C-vUsR_k.js";import{S as b}from"./Segment-CHSCcjc6.js";import{T as g}from"./Transition-CRc2xu3K.js";import{i as c}from"./i18n-DkobdbHY.js";import{L as v}from"./LinkLabel-DJUf1Fs9.js";import"./extends-CCbyfPlC.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./getElementType-Dbrg5pYk.js";import"./Button-BDHbVLWx.js";import"./Icon-DvprR8oi.js";import"./Label-D1PIeSX5.js";import"./ModernAutoControlledComponent-QVsiK7km.js";import"./assertThisInitialized-B9jnkVVz.js";import"./includes-eGroWB-Q.js";import"./toFinite-CzVf2XkS.js";import"./forEach-CbH1wg7D.js";import"./Dimmer-Fz-z8WIU.js";import"./Portal-C6ILt24N.js";import"./keyboardKey-DeBoM4Ub.js";import"./map-uhZzoJ4W.js";import"./Checkbox-mMJwNdkd.js";import"./_baseSet-BdlGglPz.js";import"./_baseAssignValue-Bri4X6-V.js";import"./Dropdown-C6akRp4P.js";import"./without-lQrFBxoL.js";import"./isArrayLikeObject-B5eiN9N1.js";import"./isEmpty-9Dhr09Zy.js";import"./deburr-CTkioK7w.js";import"./index-DY9fuINF.js";import"./_arrayReduce-CrxnWFSq.js";import"./filter-0P9hSMEf.js";import"./Input-CulkMBuo.js";import"./i18next-eNuDfwAU.js";import"./LinkButton-MVjGmgvy.js";class a extends l.Component{static defaultProps;constructor(t){super(t),this.state={showKeyboard:!1}}componentDidUpdate(t){t.visible&&!this.props.visible&&this.setState({showKeyboard:!1})}onInputChange(t,s){this.props.onChange(t,s)}onKeyboardChange(t){this.props.onChange(null,{value:t})}render(){return e.jsxs(d.Field,{className:"keyboard-field",children:[e.jsx(d.Input,{autoFocus:this.props.autoFocus,className:this.props.className,error:this.props.error,id:this.props.id,input:{"aria-label":this.props.name},label:this.renderLabel(),name:this.props.name,onChange:this.onInputChange.bind(this),required:this.props.required,value:this.props.value,children:this.props.children}),e.jsx(g,{duration:{hide:50,show:500},visible:this.state.showKeyboard,children:e.jsx(b,{children:e.jsx(f,{layout:this.props.layout,onChange:this.onKeyboardChange.bind(this),value:this.props.value,keyboardClass:this.props.name})})})]})}renderLabel(){return e.jsx(v,{content:this.state.showKeyboard?c.t("KeyboardField.labels.hideKeyboard"):c.t("KeyboardField.labels.showKeyboard"),htmlFor:this.props.name,label:this.props.label,onClick:()=>this.setState(t=>({showKeyboard:!t.showKeyboard}))})}}a.defaultProps={autoFocus:!1,className:"",error:!1,id:""};a.__docgenInfo={description:"",methods:[{name:"onInputChange",docblock:`Triggers the text input change.
