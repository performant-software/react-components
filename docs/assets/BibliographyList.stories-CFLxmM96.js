...
The consuming component is responsible for tracking the selected items.`},showRecordCount:{required:!1,flowType:{name:"boolean"},description:"If <code>true</code>, the total number of records will display in the list header."},items:{required:!0,flowType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  uid?: string,
  data: any
}`,signature:{properties:[{key:"id",value:{name:"number",required:!1}},{key:"uid",value:{name:"string",required:!1}},{key:"data",value:{name:"any",required:!0}}]}}],raw:"Array<Item>"},description:"The array of bibliography items."},translateUrl:{required:!0,flowType:{name:"string"},description:"URL of the Zotero translation server."}}};const Lt={title:"Components/Semantic UI/BibliographyList",component:D,decorators:[F.withKnobs]},f=()=>{const[e,m]=a.useState([{id:1,uid:"A",data:{itemType:"book",title:"First Test",creators:[{creatorType:"author",nameType:1,firstName:"Author",lastName:"Test"}]}},{id:2,uid:"B",data:{itemType:"book",title:"Second test"}}]),p=a.useCallback(o=>m(c=>i.filter(c,y=>y.uid!==o.uid)),[]),r=a.useCallback(o=>{const c=i.findWhere(e,{uid:o.uid});m(c?y=>i.map(y,s=>s===c?o:s):y=>[...y,o])},[e]);return n.jsx(D,{items:e,onDelete:p,onSave:r,translateUrl:"/translate"})};f.__docgenInfo={description:"",methods:[],displayName:"Default"};var I,E,A;f.parameters={...f.parameters,docs:{...(I=f.parameters)==null?void 0:I.docs,source:{originalSource:`() => {
