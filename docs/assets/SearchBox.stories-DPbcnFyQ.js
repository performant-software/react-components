import{r as a,j as s}from"./iframe-CobmjQJx.js";import"./index.es28-C7GyLKAW.js";import{o as f}from"./index.es35-NGGuPWEW.js";import{I as q}from"./Icon-GUvrG6NX.js";import{I as B}from"./Input-DmEhvK3s.js";import{_ as y}from"./index-default-C0I3bBxV.js";import"./extends-CCbyfPlC.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./getElementType-DIRvTXcE.js";import"./includes-BzBOEv5Z.js";import"./toFinite-BcRf1gcc.js";import"./map-Be6cYnHc.js";import"./Label-BcJmCt3K.js";import"./ModernAutoControlledComponent-BY7sqkaA.js";import"./assertThisInitialized-B9jnkVVz.js";import"./forEach-BqzC2Qd6.js";import"./Dimmer-B-_T9QPF.js";import"./Portal-DxbNXBbZ.js";import"./keyboardKey-CpnYesMy.js";import"./Button-Dbwe2y1K.js";const i=({useSearchBox:u,...e})=>{const{query:r,refine:p,clear:d,isSearchStalled:g}=u(e),[l,S]=a.useState(r),h=a.useRef(),x=a.useCallback(()=>{S(""),d();const{current:m}=h;m&&m.focus()},[d]),v=a.useCallback(()=>p(l),[p,l]);return s.jsx(B,{...e,"aria-label":"Search",icon:s.jsx(q,{link:!y.isEmpty(r),name:y.isEmpty(r)?"search":"times",onClick:x}),input:{"aria-label":"search"},loading:g,onChange:(m,{value:_})=>S(_),onKeyDown:()=>f.clearSearchTimer(),onKeyUp:()=>f.setSearchTimer(v),ref:h,type:"text",value:l})};i.__docgenInfo={description:"This component is used with the `useSearchBox` function from Instant Search Hooks and renders an input element that\nwhen changed will execute a new query.",methods:[],displayName:"SearchBox",props:{useSearchBox:{required:!0,flowType:{name:"signature",type:"function",raw:`(props: any) => ({
  query: string,
