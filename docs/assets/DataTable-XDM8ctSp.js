import{j as a,r as p}from"./iframe-ColLpCq0.js";import{c as h}from"./index.es28-aRnl8fXs.js";import{J as b}from"./index.es33-C8iyb9Mp.js";import{T as o}from"./Table-CtBzFEaH.js";import{B as c}from"./Button-DLliuTg0.js";import{L as q}from"./Loader-D78Sy4dK.js";import{C as v}from"./Checkbox-DM_54-HN.js";import{P as x}from"./Popup-DQCXRDcc.js";import{_ as i}from"./index-default-C0I3bBxV.js";import{i as k}from"./i18n-C0aeT7bv.js";import{I as E}from"./Icon-VLftFoWa.js";import{D as f}from"./Dropdown-DQ57WfiI.js";import{D as S}from"./Draggable-BQkKReEG.js";import{L as g,S as T}from"./DataList-DkzqcVcH.js";import{u as R}from"./List-DPQABB4H.js";import{R as j}from"./Portal-Ci3UlCdp.js";const C=d=>a.jsx("div",{className:"column-resize",onMouseDown:d.onMouseDown.bind(void 0),role:"presentation",children:" "});C.__docgenInfo={description:"",methods:[],displayName:"ColumnResize",props:{onMouseDown:{required:!0,flowType:{name:"signature",type:"function",raw:"(e: MouseEvent) => void",signature:{arguments:[{name:"e",type:{name:"MouseEvent"}}],return:{name:"void"}}},description:""}}};const u={list:0,grid:1,table:2},O=d=>class extends p.Component{static defaultProps={basic:!0,hideToggle:!1,sort:[]};sortDropdown;constructor(e){super(e);const{key:n,storage:t}=e.session||{},r=g.restoreSession(n,t)||{};this.state={view:r.view||e.defaultView||u.list}}getSortValue(){const e=i.find(this.props.sort,{value:this.props.sortColumn});return e&&e.text}isHidden(){return this.props.hideToggle&&i.isEmpty(this.props.sort)&&!this.props.renderListHeader}onSort(e){if(!this.props.onSort)return;let n;e.value!==this.props.sortColumn&&(n=e.direction),this.props.onSort(e.value,n)}componentDidUpdate(e,n){n.view!==this.state.view&&this.setSession()}setSession(){const{key:e,storage:n}=this.props.session||{};e&&g.setSession(e,n,{view:this.state.view})}render(){return a.jsx(d,{...this.props,renderListHeader:this.renderHeader.bind(this),view:this.state.view})}renderHeader(){return this.isHidden()?null:a.jsxs(a.Fragment,{children:[this.props.renderListHeader&&this.props.renderListHeader(),!this.props.hideToggle&&a.jsxs(a.Fragment,{children:[a.jsx(c,{active:this.state.view===u.list,"aria-label":"List View",basic:this.props.basic,icon:"list",onClick:()=>this.setState({view:u.list})}),a.jsx(c,{active:this.state.view===u.grid,"aria-label":"Grid View",basic:this.props.basic,icon:"grid layout",onClick:()=>this.setState({view:u.grid})}),!i.isEmpty(this.props.columns)&&a.jsx(c,{active:this.state.view===u.table,"aria-label":"Table View",basic:this.props.basic,icon:"table",onClick:()=>this.setState({view:u.table})})]}),!i.isEmpty(this.props.sort)&&this.props.onSort&&a.jsxs(c.Group,{basic:this.props.basic,color:this.props.sortColor,style:{fontSize:"inherit"},children:[a.jsx(c,{"aria-label":"Sort by",content:this.getSortValue(),icon:this.props.sortDirection===T?"sort alphabet up":"sort alphabet down",onClick:e=>this.sortDropdown.handleClick(e)}),a.jsx(f,{"aria-label":"Sort",className:"button icon",floating:!0,options:i.map(this.props.sort,e=>({...e,onClick:this.onSort.bind(this,e)})),ref:e=>{this.sortDropdown=e},trigger:a.jsx(a.Fragment,{}),value:this.props.sortColumn})]})]})}},H=d=>class extends p.Component{static defaultProps={className:""};constructor(e){super(e),this.state=this.initializeState(e)}componentDidUpdate(e,n){b.isEqual(e.columns,this.props.columns)||this.setState({columns:this.props.columns}),b.isEqual(n.columns,this.state.columns)||this.setSession()}initializeState(e){const{key:n,storage:t}=e.session||{},r=g.restoreSession(n,t)||{};if(i.isEmpty(r.columns))return{columns:e.columns};const l=[];i.each(r.columns,s=>{const y=i.findWhere(e.columns,{name:s.name});y&&l.push({...y,...s})});const m=i.pluck(l,"name");return i.each(e.columns,s=>{i.contains(m,s.name)||l.push(s)}),i.each(l,s=>{!s.hidden&&s.onShow&&s.onShow()}),{columns:l}}onColumnCheckbox(e){e.hidden&&e.onShow&&e.onShow(),!e.hidden&&e.onHide&&e.onHide(),this.setState(n=>({columns:i.map(n.columns,t=>t.name===e.name?{...t,hidden:!t.hidden}:t)}))}onDrag(e,n){this.setState(t=>{const r=[],l=[];i.each(t.columns,(s,y)=>{s.label&&s.label.length?r.push(s):l.push({index:y,column:s})});const m=r[e];return r.splice(e,1),r.splice(n,0,m),i.each(l,s=>r.splice(s.index,0,s.column)),{columns:r}})}render(){return a.jsx(d,{...this.props,className:`data-table-column-selector ${this.props.className}`,columns:this.state.columns,renderListHeader:this.renderHeader.bind(this)})}renderHeader(){if(!(this.props.configurable||this.props.renderListHeader))return null;const e=this.props.view===void 0||this.props.view===u.table;return a.jsxs(a.Fragment,{children:[this.props.renderListHeader&&this.props.renderListHeader(),this.props.configurable&&e&&a.jsx(f,{"aria-label":"Select Columns",basic:!0,button:!0,icon:"cog",className:"icon configure-button open-right",closeOnBlur:!1,scrolling:!0,children:a.jsx(f.Menu,{children:this.state.columns.filter(n=>n.label&&n.label.length).map((n,t)=>a.jsx(S,{id:n.name,index:t,onDrag:this.onDrag.bind(this),children:a.jsxs(f.Item,{"aria-dropeffect":"move",onClick:r=>r.stopPropagation(),children:[a.jsx(E,{name:"bars"}),a.jsx(v,{"aria-label":"Select Column",checked:!n.hidden,label:n.label,onClick:this.onColumnCheckbox.bind(this,n)})]})},n.name))})})]})}setSession(){const{key:e,storage:n}=this.props.session||{};if(!e)return;const t=i.map(this.state.columns,r=>i.pick(r,"name","hidden"));g.setSession(e,n,{columns:t})}};class w extends p.Component{static defaultProps;columnRefs;onClick;onMouseMove;onMouseUp;constructor(e){super(e),this.state={resize:null,activePanel:null},this.initializeColumnRefs(),this.onClick=this.onPreventClick.bind(this),this.onMouseMove=this.onColumnResize.bind(this),this.onMouseUp=this.afterColumnResize.bind(this)}afterColumnResize(){this.state.resize&&h.isBrowser()&&(document.addEventListener("click",this.onClick,!0),this.setState({resize:void 0}))}initializeColumnRefs(){this.columnRefs={},i.each(this.props.columns,e=>{this.columnRefs[e.name]=p.createRef()})}componentDidMount(){h.isBrowser()&&(document.addEventListener("mousemove",this.onMouseMove),document.addEventListener("mouseup",this.onMouseUp))}componentDidUpdate(e){b.isEqual(e.columns,this.props.columns)||this.initializeColumnRefs()}componentWillUnmount(){h.isBrowser()&&(document.removeEventListener("mousemove",this.onMouseMove),document.removeEventListener("mouseup",this.onMouseUp))}getColumnCount(){let e=this.props.columns.length;return this.props.actions&&this.props.actions.length&&(e+=1),e}onColumnResize(e){const{resize:n}=this.state;if(n){const{columnRef:t,offset:r}=n;t.current.style.width=`${r+e.pageX}px`}}onPreventClick(e){e.stopPropagation(),h.isBrowser()&&document.removeEventListener("click",this.onClick,!0)}onSelectAll(e){let n;e?n=[...this.props.items||[]]:n=i.reject(this.props.items,this.props.isRowSelected.bind(this)),i.each(n,this.props.onRowSelect&&this.props.onRowSelect.bind(this))}render(){return a.jsxs(o,{className:"data-table",...this.props.tableProps,children:[a.jsx(o.Header,{children:a.jsxs(o.Row,{children:[this.renderSelectHeader(),this.props.columns.map(this.renderHeaderCell.bind(this)),this.renderActionsHeader()]})}),a.jsxs(o.Body,{children:[this.props.items&&this.props.items.map(this.renderItem.bind(this)),this.renderEmptyTableRow(),this.renderLoading()]})]})}renderActionButton(e,n,t){if(t.render)return t.render(e,n);const{asProps:r=()=>({})}=t,l=p.createElement(c,{"aria-label":t.name,as:t.as,...r(e),basic:!0,compact:!0,color:t.resolveColor?t.resolveColor(e):t.color,icon:t.resolveIcon?t.resolveIcon(e):t.icon,key:`${t.name}-${n}`,onClick:t.onClick&&t.onClick.bind(this,e,n),title:t.title});if(t.popup){const{content:m,title:s}=t.popup;return a.jsx(x,{content:m,header:s,hideOnScroll:!0,mouseEnterDelay:500,position:"top right",trigger:l},`${t.name}-${n}`)}return l}renderActions(e,n){if(!(this.props.actions&&this.props.actions.length))return null;const t=this.props.actions.filter(r=>!r.accept||r.accept(e));return a.jsx(o.Cell,{className:"actions-cell",children:t.map(this.renderActionButton.bind(this,e,n))},n)}renderActionsHeader(){return this.props.actions&&this.props.actions.length?a.jsx(o.HeaderCell,{children:k.t("DataTable.columns.actions")}):null}renderCell(e,n){if(n.hidden)return null;let t;return n.render?t=n.render(e):n.resolve?t=n.resolve(e):t=e[n.name],a.jsx(o.Cell,{className:n.className,children:t},`${e.id}-${n.name}`)}renderEmptyTableRow(){return this.props.loading||this.props.items&&this.props.items.length?null:this.props.renderEmptyRow?this.props.renderEmptyRow():a.jsx(o.Row,{children:a.jsx(o.Cell,{colSpan:this.getColumnCount(),textAlign:"center",children:a.jsx("div",{className:"empty-container",children:this.props.renderEmptyMessage()})})})}renderHeaderCell(e){return e.hidden?null:e.renderHeader?e.renderHeader():a.jsx(j,{innerRef:this.columnRefs[e.name],children:a.jsxs(o.HeaderCell,{sorted:this.props.sortColumn===e.name?this.props.sortDirection:null,onClick:()=>this.props.onColumnClick(e),children:[e.label,a.jsx(C,{onMouseDown:n=>{const t=this.columnRefs[e.name],r=t.current.offsetWidth-n.pageX;this.setState({resize:{columnRef:t,offset:r}})}})]},e.name)},e.name)}renderItem(e,n){const t=[this.renderSelectCheckbox(e,n),this.props.columns.map(this.renderCell.bind(this,e)),this.renderActions(e,n)],r=l=>{l.target.nodeName==="TD"&&this.setState(m=>({activePanel:m.activePanel===e.id?"":e.id}))};return this.props.renderItem?this.props.renderItem(e,n,t):a.jsxs(p.Fragment,{children:[a.jsx(o.Row,{onClick:this.props.expandableRows?r:()=>{},className:this.props.expandableRows?"expandable":"",children:t}),this.props.expandableRows&&a.jsx(o.Row,{className:this.state.activePanel===e.id?"expanded-panel":"hidden",children:this.props.expandPanel&&this.props.expandPanel(e,this.state.activePanel)})]},n)}renderLoading(){return this.props.loading?a.jsx(o.Row,{children:a.jsx(o.Cell,{colSpan:this.getColumnCount(),textAlign:"center",children:a.jsx(q,{active:!0,content:k.t("DataTable.loading"),inline:!0})})}):null}renderSelectCheckbox(e,n){return this.props.selectable&&this.props.onRowSelect&&this.props.isRowSelected?a.jsx(o.Cell,{className:"select-cell",children:a.jsx(v,{onClick:this.props.onRowSelect.bind(this,e),checked:this.props.isRowSelected(e)})},`select-cell-${n}`):null}renderSelectHeader(){if(!this.props.selectable)return null;const e=!!(this.props.items&&this.props.items.length&&i.every(this.props.items,this.props.isRowSelected.bind(this)));return a.jsx(o.HeaderCell,{className:"select-cell",children:a.jsx(v,{onClick:this.onSelectAll.bind(this,e),checked:e})})}}w.defaultProps={actions:void 0,addButton:{location:"top",color:"green"},buttons:[],count:0,className:"",csvExportButton:void 0,expandableRows:!1,expandPanel:void 0,filters:void 0,items:[],loading:!1,modal:void 0,page:1,pages:1,onColumnClick:()=>{},onCopy:void 0,onPageChange:()=>{},renderDeleteModal:void 0,renderEmptyRow:void 0,renderSearch:void 0,renderItem:void 0,showRecordCount:!1,sortColumn:void 0,sortDirection:void 0};const W=H(R(w));w.__docgenInfo={description:"",methods:[{name:"afterColumnResize",docblock:`If the resize object is present on the state, sets the capture click handler on the document and
