import{r,j as t}from"./iframe-DTMBAB_o.js";import{g as s,F as u}from"./peripleo-maplibre.es8-Dclndq4X.js";import{s as d}from"./peripleo-maplibre.es40-RZubYBHI.js";import{_ as f,M as c}from"./Map-Rchr5p6n.js";import{M as a}from"./MapStyles-DKLIG4Qa.js";const y=2,l=e=>{const n=d(),i=r.useMemo(()=>f.isEmpty(e.data)?null:e.data,[e.data]);return r.useEffect(()=>{if(n&&i&&e.fitBoundingBox){const o=e.boundingBox??c.getBoundingBox(i,e.buffer);o&&n.fitBounds(o,e.boundingBoxOptions,e.boundingBoxData)}},[n,e.buffer,e.data,e.boundingBox,e.boundingBoxData,e.boundingBoxOptions,e.fitBoundingBox]),i?t.jsxs(t.Fragment,{children:[e.animate&&t.jsx(s,{data:e.data,id:e.layerId}),t.jsx(u,{cluster:e.cluster,clusterMaxZoom:e.clusterMaxZoom,clusterMinPoints:e.clusterMinPoints,clusterProperties:e.clusterProperties,clusterRadius:e.clusterRadius,data:e.data,fillStyle:e.fillStyle,id:e.layerId,interactive:e.interactive,strokeStyle:e.strokeStyle,pointStyle:e.pointStyle,visible:e.visible})]}):null};l.defaultProps={buffer:y,fillStyle:a.fill,fitBoundingBox:!0,pointStyle:a.point,strokeStyle:a.stroke};l.__docgenInfo={description:"This component renders a location marker to be used in a Peripleo context.",methods:[],displayName:"LocationMarkers",props:{animate:{required:!1,flowType:{name:"boolean"},description:"If `true`, the point marker will display with a pulsing animation."},boundingBox:{required:!1,flowType:{name:"any"},description:`(Optional) bounding box to fit the map to.
If not provided, the bounding box will be calculated from the data.`},boundingBoxData:{required:!1,flowType:{name:"any"},description:"(Optional) data to pass to the fitToBounds function."},boundingBoxOptions:{required:!1,flowType:{name:"any"},description:`(Optional) options to pass to the fitToBounds function.
...
}`,computed:!1}},visible:{required:!1,flowType:{name:"boolean"},description:"If true, the layer will be visible on the map."}}};export{l as L};
