 ...
 */const u=s("CircleUser",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["circle",{cx:"12",cy:"10",r:"3",key:"ilqhr7"}],["path",{d:"M7 20.662V19a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v1.662",key:"154egf"}]]),r=t=>e.jsx(i,{data:t.data,emptyMessage:a.t("RelatedPeople.labels.empty"),renderItem:n=>e.jsxs(e.Fragment,{children:[e.jsx(u,{className:"h-4 w-4 mr-1.5"}),n.body.title]})}),p=r;r.__docgenInfo={description:"This component renders the related Core Data organizations.",methods:[],displayName:"RelatedPeople",props:{data:{required:!0,flowType:{name:"signature",type:"object",raw:`{
  ...
  label: string,
  value: string
}`,signature:{properties:[{key:"label",value:{name:"string",required:!0}},{key:"value",value:{name:"string",required:!0}}]},required:!0}}]},required:!0}}]}}],raw:"Annotation<T>[]",required:!0}}]}},description:"The annotation page containing the Core Data people to render."}}};export{p as R};
