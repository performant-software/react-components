import{r as l,j as e}from"./iframe-DT7QbYH7.js";import{F as d}from"./Form-BQyRKPEr.js";import{E as h,A as y}from"./english-BQymWagN.js";import{y as f}from"./index.es28-DplMxnFD.js";import{S as b}from"./Segment-tg9Kf_vR.js";import{T as g}from"./Transition-BCar87ro.js";import{i as c}from"./i18n-DkobdbHY.js";import{L as v}from"./LinkLabel-3rvlGA9K.js";import"./extends-CCbyfPlC.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./getElementType-D9Dm3kUn.js";import"./Button-NSPqHwS_.js";import"./Icon-ey9jiNEy.js";import"./Label-BiRn_-_3.js";import"./ModernAutoControlledComponent-Cz85Fsnf.js";import"./assertThisInitialized-B9jnkVVz.js";import"./includes-DlRNvmPY.js";import"./toFinite-EWrCJB8-.js";import"./forEach-CUQnNrTW.js";import"./Dimmer-C1tpBS2T.js";import"./Portal-Dqo72CYe.js";import"./keyboardKey-8QW-HgB9.js";import"./map-CN2A-66k.js";import"./Checkbox-BruMkqRI.js";import"./_baseSet-DYVjP9W1.js";import"./_baseAssignValue-DsBxPc0Q.js";import"./Dropdown-B06UXL3V.js";import"./without-CmhwM1cQ.js";import"./isArrayLikeObject-PvVLkR8c.js";import"./isEmpty-ChjRJg2c.js";import"./deburr-C41nhHE6.js";import"./index-bnJZsReu.js";import"./_arrayReduce-CrxnWFSq.js";import"./filter-COQqCgju.js";import"./Input-EBrwWnz0.js";import"./i18next-eNuDfwAU.js";import"./LinkButton-57ML1Ypp.js";class a extends l.Component{static defaultProps;constructor(t){super(t),this.state={showKeyboard:!1}}componentDidUpdate(t){t.visible&&!this.props.visible&&this.setState({showKeyboard:!1})}onInputChange(t,s){this.props.onChange(t,s)}onKeyboardChange(t){this.props.onChange(null,{value:t})}render(){return e.jsxs(d.Field,{className:"keyboard-field",children:[e.jsx(d.Input,{autoFocus:this.props.autoFocus,className:this.props.className,error:this.props.error,id:this.props.id,input:{"aria-label":this.props.name},label:this.renderLabel(),name:this.props.name,onChange:this.onInputChange.bind(this),required:this.props.required,value:this.props.value,children:this.props.children}),e.jsx(g,{duration:{hide:50,show:500},visible:this.state.showKeyboard,children:e.jsx(b,{children:e.jsx(f,{layout:this.props.layout,onChange:this.onKeyboardChange.bind(this),value:this.props.value,keyboardClass:this.props.name})})})]})}renderLabel(){return e.jsx(v,{content:this.state.showKeyboard?c.t("KeyboardField.labels.hideKeyboard"):c.t("KeyboardField.labels.showKeyboard"),htmlFor:this.props.name,label:this.props.label,onClick:()=>this.setState(t=>({showKeyboard:!t.showKeyboard}))})}}a.defaultProps={autoFocus:!1,className:"",error:!1,id:""};a.__docgenInfo={description:"",methods:[{name:"onInputChange",docblock:`Triggers the text input change.
