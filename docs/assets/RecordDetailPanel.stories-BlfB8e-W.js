import{r as a,j as e}from"./iframe-D2tDQHIu.js";import{_ as T}from"./index-default-B8-H6N8J.js";import{K as C}from"./KeyValueList-kqjx__p5.js";import{c as u}from"./clsx-B-dksMZM.js";import{A as J}from"./AccordionItemsList-t7wgKpf2.js";import{I as U}from"./Icon-ByOer4nh.js";import{L}from"./LoadAnimation-Dvm-xKbQ.js";import{R as B}from"./RecordDetailBreadcrumbs-CLJERrdU.js";import{B as E}from"./Button-ZaAs9yFA.js";import{i as D}from"./i18n-DtnBOa9t.js";import{R as O}from"./RecordDetailItem-Dynnt_Ny.js";import{R as V}from"./RecordDetailHeader-CUWt3ZpT.js";import"./index-ME5cgDsZ.js";import"./extends-CCbyfPlC.js";import"./index-C6YE8WSz.js";import"./index-IjE9GaUh.js";import"./index-DRw6srTX.js";import"./toPropertyKey-BdisF6oo.js";import"./defineProperty-BhpcgfZc.js";import"./inherits-DDprkOLY.js";import"./assertThisInitialized-B9jnkVVz.js";import"./setPrototypeOf-DgZC2w_0.js";import"./createClass-CGi6Kyeu.js";import"./RecordDetailTitle-1T0Q8weL.js";const Q=i=>{const[s,l]=a.useState(!1),[c,R]=a.useState(!1),[P,W]=a.useState(0),[I,_]=a.useState(0),k=a.useRef(null),A=a.useMemo(()=>new ResizeObserver(n=>{const{target:S}=n[0];W(S.scrollHeight),_(S.clientHeight)}),[]),M=a.useCallback(n=>{n?(k.current=n,A.observe(n)):k.current=null},[A]);return a.useEffect(()=>{k.current&&R(P>I||s)},[P,I]),a.useEffect(()=>{l(!1)},[i.children,i.items]),a.useEffect(()=>()=>A.disconnect(),[]),e.jsxs("div",{className:i.classNames?.root,children:[e.jsxs("div",{className:u("flex","flex-col","relative",{"max-h-[250px]":!s}),children:[e.jsxs("div",{className:"overflow-hidden",ref:M,children:[e.jsx("ul",{className:i.classNames?.items,children:T.map(i.items,(n,S)=>e.jsx(O,{className:n.className,icon:n.icon,text:n.text},S))}),i.children]}),c&&!s&&e.jsx("div",{className:"absolute left-0 bottom-0 w-full h-[50px] bg-gradient-to-b from-white/50 to-white/100"})]}),c&&e.jsx(E,{className:"w-full justify-center mb-4",onClick:()=>l(n=>!n),rounded:!0,children:s?D.t("RecordDetailHeader.showLess"):D.t("RecordDetailHeader.showMore")})]})};Q.__docgenInfo={description:"",methods:[],displayName:"RecordDetailContent",props:{children:{required:!1,flowType:{name:"Node"},description:""},classNames:{required:!1,flowType:{name:"signature",type:"object",raw:`{
  root?: string,
  items?: string
