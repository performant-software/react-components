import{j as t,r as p}from"./iframe-DTMBAB_o.js";import{c as h}from"./index.es28-B7MYg7zV.js";import{J as b}from"./index.es33-Cr-tXtwL.js";import{T as o}from"./Table-CbO6hk55.js";import{B as c}from"./Button-BNNyQwcZ.js";import{L as q}from"./Loader-MSvHhoSe.js";import{C as v}from"./Checkbox-BHndQ9Yd.js";import{P as x}from"./Popup-Dza6s0LS.js";import{_ as i}from"./index-default-C0I3bBxV.js";import{i as k}from"./i18n-DkobdbHY.js";import{I as E}from"./Icon-CznQEfm0.js";import{D as f}from"./Dropdown-cvYziEoi.js";import{D as S}from"./Draggable-Dv7D5TU5.js";import{L as g,S as T}from"./DataList-CIs1Maa_.js";import{u as R}from"./List-D1gV0qd5.js";import{R as j}from"./Portal-DZuQlAAB.js";const C=d=>t.jsx("div",{className:"column-resize",onMouseDown:d.onMouseDown.bind(void 0),role:"presentation",children:" "});C.__docgenInfo={description:"",methods:[],displayName:"ColumnResize",props:{onMouseDown:{required:!0,flowType:{name:"signature",type:"function",raw:"(e: MouseEvent) => void",signature:{arguments:[{name:"e",type:{name:"MouseEvent"}}],return:{name:"void"}}},description:""}}};const u={list:0,grid:1,table:2},O=d=>class extends p.Component{static defaultProps={basic:!0,hideToggle:!1,sort:[]};sortDropdown;constructor(e){super(e);const{key:n,storage:a}=e.session||{},r=g.restoreSession(n,a)||{};this.state={view:r.view||e.defaultView||u.list}}getSortValue(){const e=i.find(this.props.sort,{value:this.props.sortColumn});return e&&e.text}isHidden(){return this.props.hideToggle&&i.isEmpty(this.props.sort)&&!this.props.renderListHeader}onSort(e){if(!this.props.onSort)return;let n;e.value!==this.props.sortColumn&&(n=e.direction),this.props.onSort(e.value,n)}componentDidUpdate(e,n){n.view!==this.state.view&&this.setSession()}setSession(){const{key:e,storage:n}=this.props.session||{};e&&g.setSession(e,n,{view:this.state.view})}render(){return t.jsx(d,{...this.props,renderListHeader:this.renderHeader.bind(this),view:this.state.view})}renderHeader(){return this.isHidden()?null:t.jsxs(t.Fragment,{children:[this.props.renderListHeader&&this.props.renderListHeader(),!this.props.hideToggle&&t.jsxs(t.Fragment,{children:[t.jsx(c,{active:this.state.view===u.list,"aria-label":"List View",basic:this.props.basic,icon:"list",onClick:()=>this.setState({view:u.list})}),t.jsx(c,{active:this.state.view===u.grid,"aria-label":"Grid View",basic:this.props.basic,icon:"grid layout",onClick:()=>this.setState({view:u.grid})}),!i.isEmpty(this.props.columns)&&t.jsx(c,{active:this.state.view===u.table,"aria-label":"Table View",basic:this.props.basic,icon:"table",onClick:()=>this.setState({view:u.table})})]}),!i.isEmpty(this.props.sort)&&this.props.onSort&&t.jsxs(c.Group,{basic:this.props.basic,color:this.props.sortColor,style:{fontSize:"inherit"},children:[t.jsx(c,{"aria-label":"Sort by",content:this.getSortValue(),icon:this.props.sortDirection===T?"sort alphabet up":"sort alphabet down",onClick:e=>this.sortDropdown.handleClick(e)}),t.jsx(f,{"aria-label":"Sort",className:"button icon",floating:!0,options:i.map(this.props.sort,e=>({...e,onClick:this.onSort.bind(this,e)})),ref:e=>{this.sortDropdown=e},trigger:t.jsx(t.Fragment,{}),value:this.props.sortColumn})]})]})}},H=d=>class extends p.Component{static defaultProps={className:""};constructor(e){super(e),this.state=this.initializeState(e)}componentDidUpdate(e,n){b.isEqual(e.columns,this.props.columns)||this.setState({columns:this.props.columns}),b.isEqual(n.columns,this.state.columns)||this.setSession()}initializeState(e){const{key:n,storage:a}=e.session||{},r=g.restoreSession(n,a)||{};if(i.isEmpty(r.columns))return{columns:e.columns};const l=[];i.each(r.columns,s=>{const y=i.findWhere(e.columns,{name:s.name});y&&l.push({...y,...s})});const m=i.pluck(l,"name");return i.each(e.columns,s=>{i.contains(m,s.name)||l.push(s)}),i.each(l,s=>{!s.hidden&&s.onShow&&s.onShow()}),{columns:l}}onColumnCheckbox(e){e.hidden&&e.onShow&&e.onShow(),!e.hidden&&e.onHide&&e.onHide(),this.setState(n=>({columns:i.map(n.columns,a=>a.name===e.name?{...a,hidden:!a.hidden}:a)}))}onDrag(e,n){this.setState(a=>{const r=[],l=[];i.each(a.columns,(s,y)=>{s.label&&s.label.length?r.push(s):l.push({index:y,column:s})});const m=r[e];return r.splice(e,1),r.splice(n,0,m),i.each(l,s=>r.splice(s.index,0,s.column)),{columns:r}})}render(){return t.jsx(d,{...this.props,className:`data-table-column-selector ${this.props.className}`,columns:this.state.columns,renderListHeader:this.renderHeader.bind(this)})}renderHeader(){if(!(this.props.configurable||this.props.renderListHeader))return null;const e=this.props.view===void 0||this.props.view===u.table;return t.jsxs(t.Fragment,{children:[this.props.renderListHeader&&this.props.renderListHeader(),this.props.configurable&&e&&t.jsx(f,{"aria-label":"Select Columns",basic:!0,button:!0,icon:"cog",className:"icon configure-button open-right",closeOnBlur:!1,scrolling:!0,children:t.jsx(f.Menu,{children:this.state.columns.filter(n=>n.label&&n.label.length).map((n,a)=>t.jsx(S,{id:n.name,index:a,onDrag:this.onDrag.bind(this),children:t.jsxs(f.Item,{"aria-dropeffect":"move",onClick:r=>r.stopPropagation(),children:[t.jsx(E,{name:"bars"}),t.jsx(v,{"aria-label":"Select Column",checked:!n.hidden,label:n.label,onClick:this.onColumnCheckbox.bind(this,n)})]})},n.name))})})]})}setSession(){const{key:e,storage:n}=this.props.session||{};if(!e)return;const a=i.map(this.state.columns,r=>i.pick(r,"name","hidden"));g.setSession(e,n,{columns:a})}};class w extends p.Component{static defaultProps;columnRefs;onClick;onMouseMove;onMouseUp;constructor(e){super(e),this.state={resize:null,activePanel:null},this.initializeColumnRefs(),this.onClick=this.onPreventClick.bind(this),this.onMouseMove=this.onColumnResize.bind(this),this.onMouseUp=this.afterColumnResize.bind(this)}afterColumnResize(){this.state.resize&&h.isBrowser()&&(document.addEventListener("click",this.onClick,!0),this.setState({resize:void 0}))}initializeColumnRefs(){this.columnRefs={},i.each(this.props.columns,e=>{this.columnRefs[e.name]=p.createRef()})}componentDidMount(){h.isBrowser()&&(document.addEventListener("mousemove",this.onMouseMove),document.addEventListener("mouseup",this.onMouseUp))}componentDidUpdate(e){b.isEqual(e.columns,this.props.columns)||this.initializeColumnRefs()}componentWillUnmount(){h.isBrowser()&&(document.removeEventListener("mousemove",this.onMouseMove),document.removeEventListener("mouseup",this.onMouseUp))}getColumnCount(){let e=this.props.columns.length;return this.props.actions&&this.props.actions.length&&(e+=1),e}onColumnResize(e){const{resize:n}=this.state;if(n){const{columnRef:a,offset:r}=n;a.current.style.width=`${r+e.pageX}px`}}onPreventClick(e){e.stopPropagation(),h.isBrowser()&&document.removeEventListener("click",this.onClick,!0)}onSelectAll(e){let n;e?n=[...this.props.items||[]]:n=i.reject(this.props.items,this.props.isRowSelected.bind(this)),i.each(n,this.props.onRowSelect&&this.props.onRowSelect.bind(this))}render(){return t.jsxs(o,{className:"data-table",...this.props.tableProps,children:[t.jsx(o.Header,{children:t.jsxs(o.Row,{children:[this.renderSelectHeader(),this.props.columns.map(this.renderHeaderCell.bind(this)),this.renderActionsHeader()]})}),t.jsxs(o.Body,{children:[this.props.items&&this.props.items.map(this.renderItem.bind(this)),this.renderEmptyTableRow(),this.renderLoading()]})]})}renderActionButton(e,n,a){if(a.render)return a.render(e,n);const{asProps:r=()=>({})}=a,l=p.createElement(c,{"aria-label":a.name,as:a.as,...r(e),basic:!0,compact:!0,color:a.color,icon:a.icon,key:`${a.name}-${n}`,onClick:a.onClick&&a.onClick.bind(this,e,n),title:a.title});if(a.popup){const{content:m,title:s}=a.popup;return t.jsx(x,{content:m,header:s,hideOnScroll:!0,mouseEnterDelay:500,position:"top right",trigger:l},`${a.name}-${n}`)}return l}renderActions(e,n){if(!(this.props.actions&&this.props.actions.length))return null;const a=this.props.actions.filter(r=>!r.accept||r.accept(e));return t.jsx(o.Cell,{className:"actions-cell",children:a.map(this.renderActionButton.bind(this,e,n))},n)}renderActionsHeader(){return this.props.actions&&this.props.actions.length?t.jsx(o.HeaderCell,{children:k.t("DataTable.columns.actions")}):null}renderCell(e,n){if(n.hidden)return null;let a;return n.render?a=n.render(e):n.resolve?a=n.resolve(e):a=e[n.name],t.jsx(o.Cell,{className:n.className,children:a},`${e.id}-${n.name}`)}renderEmptyTableRow(){return this.props.loading||this.props.items&&this.props.items.length?null:this.props.renderEmptyRow?this.props.renderEmptyRow():t.jsx(o.Row,{children:t.jsx(o.Cell,{colSpan:this.getColumnCount(),textAlign:"center",children:t.jsx("div",{className:"empty-container",children:this.props.renderEmptyMessage()})})})}renderHeaderCell(e){return e.hidden?null:e.renderHeader?e.renderHeader():t.jsx(j,{innerRef:this.columnRefs[e.name],children:t.jsxs(o.HeaderCell,{sorted:this.props.sortColumn===e.name?this.props.sortDirection:null,onClick:()=>this.props.onColumnClick(e),children:[e.label,t.jsx(C,{onMouseDown:n=>{const a=this.columnRefs[e.name],r=a.current.offsetWidth-n.pageX;this.setState({resize:{columnRef:a,offset:r}})}})]},e.name)},e.name)}renderItem(e,n){const a=[this.renderSelectCheckbox(e,n),this.props.columns.map(this.renderCell.bind(this,e)),this.renderActions(e,n)],r=l=>{l.target.nodeName==="TD"&&this.setState(m=>({activePanel:m.activePanel===e.id?"":e.id}))};return this.props.renderItem?this.props.renderItem(e,n,a):t.jsxs(p.Fragment,{children:[t.jsx(o.Row,{onClick:this.props.expandableRows?r:()=>{},className:this.props.expandableRows?"expandable":"",children:a}),this.props.expandableRows&&t.jsx(o.Row,{className:this.state.activePanel===e.id?"expanded-panel":"hidden",children:this.props.expandPanel&&this.props.expandPanel(e,this.state.activePanel)})]},n)}renderLoading(){return this.props.loading?t.jsx(o.Row,{children:t.jsx(o.Cell,{colSpan:this.getColumnCount(),textAlign:"center",children:t.jsx(q,{active:!0,content:k.t("DataTable.loading"),inline:!0})})}):null}renderSelectCheckbox(e,n){return this.props.selectable&&this.props.onRowSelect&&this.props.isRowSelected?t.jsx(o.Cell,{className:"select-cell",children:t.jsx(v,{onClick:this.props.onRowSelect.bind(this,e),checked:this.props.isRowSelected(e)})},`select-cell-${n}`):null}renderSelectHeader(){if(!this.props.selectable)return null;const e=!!(this.props.items&&this.props.items.length&&i.every(this.props.items,this.props.isRowSelected.bind(this)));return t.jsx(o.HeaderCell,{className:"select-cell",children:t.jsx(v,{onClick:this.onSelectAll.bind(this,e),checked:e})})}}w.defaultProps={actions:void 0,addButton:{location:"top",color:"green"},buttons:[],count:0,className:"",csvExportButton:void 0,expandableRows:!1,expandPanel:void 0,filters:void 0,items:[],loading:!1,modal:void 0,page:1,pages:1,onColumnClick:()=>{},onCopy:void 0,onPageChange:()=>{},renderDeleteModal:void 0,renderEmptyRow:void 0,renderSearch:void 0,renderItem:void 0,showRecordCount:!1,sortColumn:void 0,sortDirection:void 0};const W=H(R(w));w.__docgenInfo={description:"",methods:[{name:"afterColumnResize",docblock:`If the resize object is present on the state, sets the capture click handler on the document and
...
@returns {*}`,modifiers:[],params:[{name:"item",optional:!1,type:{name:"any"}},{name:"column",optional:!1,type:{name:"signature",type:"object",raw:`{
  className?: string,
  hidden?: boolean,
  label?: string,
  name: string,
...
@returns {*}`,modifiers:[],params:[{name:"column",optional:!1,type:{name:"signature",type:"object",raw:`{
  className?: string,
  hidden?: boolean,
  label?: string,
  name: string,
  ...
  resolve?: (item: any) => any,
  sortable: boolean
}`,signature:{properties:[{key:"className",value:{name:"string",required:!1}},{key:"hidden",value:{name:"boolean",required:!1}},{key:"label",value:{name:"string",required:!1}},{key:"name",value:{name:"string",required:!0}},{key:"onHide",value:{name:"signature",type:"function",raw:"(item: any) => void",signature:{arguments:[{name:"item",type:{name:"any"}}],return:{name:"void"}},required:!1}},{key:"onShow",value:{name:"signature",type:"function",raw:"(item: any) => void",signature:{arguments:[{name:"item",type:{name:"any"}}],return:{name:"void"}},required:!1}},{key:"render",value:{name:"signature",type:"function",raw:"(item: any) => Element<any>",signature:{arguments:[{name:"item",type:{name:"any"}}],return:{name:"Element",elements:[{name:"any"}],raw:"Element<any>"}},required:!1}},{key:"renderHeader",value:{name:"signature",type:"function",raw:"(item: any) => Element<any>",signature:{arguments:[{name:"item",type:{name:"any"}}],return:{name:"Element",elements:[{name:"any"}],raw:"Element<any>"}},required:!1}},{key:"resolve",value:{name:"signature",type:"function",raw:"(item: any) => any",signature:{arguments:[{name:"item",type:{name:"any"}}],return:{name:"any"}},required:!1}},{key:"sortable",value:{name:"boolean",required:!0}}]},alias:"Column"}}],returns:{type:{name:"mixed"}},description:"Renders the table header cell for the passed column."},{name:"renderItem",docblock:`Renders the table row for the passed item.
...
will display as the property value.`},configurable:{required:!1,flowType:{name:"boolean"},description:"If <code>true</code>, columns can be shown/hidden by the user."},view:{required:!1,flowType:{name:"number"},description:`Used in multi-view environments to hide the column selector if a view is selected, and it is not the
table view.`},expandableRows:{required:!1,flowType:{name:"boolean"},description:"If <code>true</code>, the rows of the table can be expanded and collapsed.",defaultValue:{value:"false",computed:!1}},expandPanel:{required:!1,flowType:{name:"signature",type:"function",raw:"(item: any, activePanel: any) => Element<any>",signature:{arguments:[{name:"item",type:{name:"any"}},{name:"activePanel",type:{name:"any"}}],return:{name:"Element",elements:[{name:"any"}],raw:"Element<any>"}}},description:"Function that returns JSX to render when the row for the passed item is expanded.",defaultValue:{value:"undefined",computed:!0}},isRowSelected:{required:!1,flowType:{name:"signature",type:"function",raw:"(item: any) => boolean",signature:{arguments:[{name:"item",type:{name:"any"}}],return:{name:"boolean"}}},description:"Callback returning <code>true</code> if the row for the passed item is selected."},items:{required:!1,flowType:{name:"Array",elements:[{name:"any"}],raw:"Array<any>",nullable:!0},description:"An array of objects to render as rows in the list.",defaultValue:{value:"[]",computed:!1}},loading:{required:!1,flowType:{name:"boolean"},description:"Set to <code>true</code> if the list is currently loading data. If true, a loading indicator will display.",defaultValue:{value:"false",computed:!1}},onClearSelected:{required:!1,flowType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Callback to clear the selected set of records."},onColumnClick:{required:!1,flowType:{name:"signature",type:"function",raw:"(column: Column) => void",signature:{arguments:[{name:"column",type:{name:"signature",type:"object",raw:`{
  ...
  resolve?: (item: any) => any,
  sortable: boolean
}`,signature:{properties:[{key:"className",value:{name:"string",required:!1}},{key:"hidden",value:{name:"boolean",required:!1}},{key:"label",value:{name:"string",required:!1}},{key:"name",value:{name:"string",required:!0}},{key:"onHide",value:{name:"signature",type:"function",raw:"(item: any) => void",signature:{arguments:[{name:"item",type:{name:"any"}}],return:{name:"void"}},required:!1}},{key:"onShow",value:{name:"signature",type:"function",raw:"(item: any) => void",signature:{arguments:[{name:"item",type:{name:"any"}}],return:{name:"void"}},required:!1}},{key:"render",value:{name:"signature",type:"function",raw:"(item: any) => Element<any>",signature:{arguments:[{name:"item",type:{name:"any"}}],return:{name:"Element",elements:[{name:"any"}],raw:"Element<any>"}},required:!1}},{key:"renderHeader",value:{name:"signature",type:"function",raw:"(item: any) => Element<any>",signature:{arguments:[{name:"item",type:{name:"any"}}],return:{name:"Element",elements:[{name:"any"}],raw:"Element<any>"}},required:!1}},{key:"resolve",value:{name:"signature",type:"function",raw:"(item: any) => any",signature:{arguments:[{name:"item",type:{name:"any"}}],return:{name:"any"}},required:!1}},{key:"sortable",value:{name:"boolean",required:!0}}]}}}],return:{name:"void"}}},description:"Callback fired when the passed column is clicked.",defaultValue:{value:"() => {}",computed:!1}},onRowSelect:{required:!1,flowType:{name:"signature",type:"function",raw:"(item: any)=> void",signature:{arguments:[{name:"item",type:{name:"any"}}],return:{name:"void"}}},description:`Callback fired when the passed item is selected. This callback is <i>only</i> fired if the <code>selectable</code>
...
component.`}}};export{W as D,u as V,H as a,w as b,O as u};
