import{j as t}from"./jsx-runtime-D9TvR9R2.js";import{a as v}from"./chunk-WFFRPTHA-B2vgThZf.js";import{r as o}from"./index-C0dDX-lL.js";import{c as Q}from"./clsx-B-dksMZM.js";import{I as te}from"./Icon-xn5eBWjd.js";import{i as T}from"./i18n-O47xwIR-.js";import{h as X}from"./Places-OKF0EhYG.js";import{s as Y}from"./Array-DQ2fdePu.js";import"./preview-errors-CzpZmerH.js";import"./index-CKJfshIT.js";import"./v4-D8aEg3BZ.js";import"./_commonjsHelpers-BosuxZz1.js";import"./i18next-CwS9wMM1.js";import"./toPropertyKey-BcUJYDQU.js";import"./defineProperty-DcNpp85p.js";import"./inherits-CWPG5jll.js";import"./assertThisInitialized-B9jnkVVz.js";import"./setPrototypeOf-DgZC2w_0.js";import"./createClass-CV9nCQMI.js";import"./getPrototypeOf-BYVhAdwF.js";const ne=e=>e.onClick?t.jsx("button",{className:"w-full border-0 text-left hover:bg-transparent",onClick:()=>e.onClick(e.item),type:"button",children:e.children}):e.children,Z=e=>{const s=o.useMemo(()=>e.attributes.slice(0,3).map(n=>n.render?n.render(e.item):e.item[n.name]),[e.attributes,e.item]);return t.jsx("li",{className:Q({"bg-neutral-200":e.isHighlight},{"hover:bg-neutral-200":!!e.onClick}),children:t.jsx(ne,{...e,children:t.jsxs("div",{className:"py-3 px-6",onPointerEnter:e.onPointerEnter?()=>e.onPointerEnter(e.item):void 0,onPointerLeave:e.onPointerLeave?()=>e.onPointerLeave(e.item):void 0,children:[t.jsx("p",{className:"font-bold text-neutral-800",children:e.title}),e.attributes&&s.some(Boolean)&&t.jsx("ul",{className:"list-none",children:e.attributes.slice(0,3).map((n,a)=>t.jsx(t.Fragment,{children:!!s[a]&&t.jsxs("li",{className:"text-sm text-neutral-800 flex gap-2 items-center list-none pl-5 pt-1",children:[t.jsx(te,{className:"min-w-[13px]",name:n.icon||"bullet",size:13}),s[a]]},n.name)}))})]})})})};Z.__docgenInfo={description:"",methods:[],displayName:"SearchListItem",props:{attributes:{required:!1,flowType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  icon?: string,
  label: string,
  name: string,
  render?: (item: any) => any
}`,signature:{properties:[{key:"icon",value:{name:"string",required:!1}},{key:"label",value:{name:"string",required:!0}},{key:"name",value:{name:"string",required:!0}},{key:"render",value:{name:"signature",type:"function",raw:"(item: any) => any",signature:{arguments:[{name:"item",type:{name:"any"}}],return:{name:"any"}},required:!1}}]}}],raw:"Attribute[]"},description:"Attributes to display (only the first three are shown)"},item:{required:!0,flowType:{name:"any"},description:"Search item object"},isHighlight:{required:!1,flowType:{name:"boolean"},description:"Boolean that determines whether to highlight the item"},onClick:{required:!1,flowType:{name:"signature",type:"function",raw:"(item: any) => void",signature:{arguments:[{name:"item",type:{name:"any"}}],return:{name:"void"}}},description:"Callback that fires when an item is clicked"},onPointerEnter:{required:!1,flowType:{name:"signature",type:"function",raw:"(item: any) => void",signature:{arguments:[{name:"item",type:{name:"any"}}],return:{name:"void"}}},description:"Callback that fires when the pointer begins to hover over an item"},onPointerLeave:{required:!1,flowType:{name:"signature",type:"function",raw:"(item: any) => void",signature:{arguments:[{name:"item",type:{name:"any"}}],return:{name:"void"}}},description:"Callback that fires when the pointer stops hovering over an item"},title:{required:!0,flowType:{name:"string"},description:"Title of the record"}}};const I=50,ie=o.memo(Z),ee=e=>{const[s,n]=o.useState(I),a=o.useRef(null),x=o.useCallback(m=>{n(l=>m.target.scrollTop/m.target.scrollHeight>=.8&&e.items.length>=l+I?l+I:l)},[e.items]);return o.useEffect(()=>(a.current&&(a.current.removeEventListener("scroll",x),a.current.addEventListener("scroll",x)),()=>{a.current&&a.current.removeEventListener("scroll",x)}),[e.items]),t.jsxs("div",{className:Q("h-full flex flex-col",e.className),children:[t.jsxs("div",{className:"text-sm italic bg-white sticky top-0 py-2.5 px-6 shadow-sm",children:[e.items.length," ",e.items.length===1?T.t("Common.words.result"):T.t("Common.words.results")]}),t.jsx("ul",{className:"overflow-y-auto h-full divide-y divide-solid divide-neutral-200",tabIndex:0,ref:a,children:e.items.slice(0,s).map((m,l)=>t.jsx(ie,{attributes:e.attributes,item:m,isHighlight:e.isHighlight&&e.isHighlight(m),title:typeof e.itemTitle=="string"?m[e.itemTitle]:e.itemTitle(m),onClick:e.onItemClick,onPointerEnter:e.onItemPointerEnter,onPointerLeave:e.onItemPointerLeave},l))})]})},i=ee;ee.__docgenInfo={description:"",methods:[],displayName:"SearchList",props:{attributes:{required:!1,flowType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  icon?: string,
  label: string,
  name: string,
  render?: (item: any) => any
