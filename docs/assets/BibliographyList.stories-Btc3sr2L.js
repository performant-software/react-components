import{r as a,j as n}from"./iframe-BrAQntzt.js";import{_ as C}from"./index-default-B8-H6N8J.js";import{r as h,t as M,i as R,d as F,p as O}from"./index.es28-DVaM09mq.js";import{G as x}from"./Grid-DtYmUSqG.js";import{M as G}from"./Message-CVHWugOq.js";import{B as j}from"./Button-D3Sj7dUS.js";import{L as k}from"./List-rwMgfFAc.js";import{_ as u}from"./index-default-C0I3bBxV.js";import{F as H}from"./Form-iQcgUtII.js";import{M as S}from"./Modal-D08A1LhU.js";import{i as v}from"./i18n-BlAkFxRx.js";import{B as V}from"./BibliographyForm-BU2LPfZ0.js";import{Z,B as W}from"./BibliographySearchInput-CJcmkIrU.js";import{D as z}from"./Dropdown-DYi_qstm.js";import{S as J}from"./StyleSelector-BoVrsgio.js";import{T as A}from"./Toaster-0TrwdBi6.js";import{u as X}from"./List-BE2bvVcT.js";import{v as Y}from"./v4-BKrj-4V8.js";import"./extends-CCbyfPlC.js";import"./getElementType-BFRWV7mM.js";import"./_getPrototype-dFVwFHqx.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./Icon-fIQ1pKxe.js";import"./map-BUR3Hk8V.js";import"./Label-C9Mv8xCs.js";import"./ModernAutoControlledComponent-CdWmntFb.js";import"./assertThisInitialized-B9jnkVVz.js";import"./includes-BJs7ARx1.js";import"./toFinite-Dfj0KU41.js";import"./toNumber-DIkYOhwr.js";import"./forEach-D05ynQet.js";import"./_arrayEach-DpGxo2Of.js";import"./Dimmer-BCOwUOme.js";import"./Portal-BQOAejov.js";import"./keyboardKey-CYtKaW6W.js";import"./Checkbox-Dp-oyyIc.js";import"./_baseSet-DKZEG50o.js";import"./_assignValue-wlBxhqFj.js";import"./_baseAssignValue-yJv1-bft.js";import"./Input-DXKF_o1r.js";import"./index-CYU-iy_c.js";import"./_arrayReduce-CrxnWFSq.js";import"./isEmpty-CIv_nSFx.js";import"./index-CW6VjT3p.js";import"./i18next-eNuDfwAU.js";import"./Bibliography-DFxvS9VE.js";import"./without-BqSAdBvz.js";import"./isArrayLikeObject-DSLl7ti9.js";import"./deburr-CAsAWVek.js";import"./isEqual-mHuJTF3G.js";import"./filter-C67l8hTY.js";import"./Transition-BThjjqtD.js";import"./Confirm-ByZ1hQ0k.js";import"./Pagination-DmqyZZcu.js";import"./_isIterateeCall-CnbN5PRK.js";import"./Menu-LUBkhXaK.js";import"./Header-DgWZM4e0.js";import"./DropdownButton-ByBGD7OJ.js";import"./EditModal-DCX8P7bS.js";import"./index.es3-0RDWrDMM.js";import"./index.es33-E6ptKalr.js";import"./Loader-Bkuz4oHD.js";import"./FuzzyDate-BOqtrsZs.js";import"./DateInput-CWk1MPaf.js";import"./AssociatedDropdown-BSZ1IA7G.js";import"./index.es35-NGGuPWEW.js";import"./Trans-CJKBHHzM.js";import"./context-Bnd_XdI4.js";const K=e=>{const[l,m]=a.useState(),r=a.useCallback(i=>{const o={...i};return h.isEmpty(o.title)&&h.isEmpty(o.creators)&&h.isEmpty(o.issue)&&h.extend(o,{title:M.t("Citation.labels.untitled")}),o},[]);return a.useEffect(()=>{if(e.locale&&e.style&&e.item){const{uid:i,...o}=e.item,c=new F({initialItems:[{key:i,...r(o)}],persist:!1}),s=h.first(c.itemsCSL),q={retrieveLocale:()=>e.locale,retrieveItem:()=>s},y=new O.Engine(q,e.style);y.updateItems([s.id]);const w=y.makeBibliography();m(h.last(w))}},[r,e.item,e.locale,e.style]),R.jsx("div",{dangerouslySetInnerHTML:{__html:l}})},B=e=>n.jsxs(S,{as:H,centered:!1,open:!0,children:[n.jsx(S.Header,{content:v.t("BibliographyModal.title")}),n.jsx(S.Content,{children:n.jsx(V,{...e})}),e.children]});B.__docgenInfo={description:"",methods:[],displayName:"BibliographyModal",props:{item:{required:!0,flowType:{name:"any"},description:""}}};const I="ascending",P="descending",_=e=>{const l=a.useRef(),m=a.useCallback(r=>{const i=e.value===r.value&&e.direction===I?P:I;e.onChange({...r,direction:i})},[e.direction,e.onChange,e.value]);return a.useEffect(()=>{if(!e.value){let r;e.defaultValue?r=u.findWhere(e.options,{value:e.defaultValue}):r=u.first(e.options),m(r)}},[]),n.jsxs(j.Group,{basic:!0,className:"sort-selector",style:{fontSize:"inherit"},children:[n.jsx(j,{"aria-label":"Sort by",content:e.text,icon:e.direction===I?"sort alphabet up":"sort alphabet down",onClick:r=>l.current.handleClick(r)}),n.jsx(z,{"aria-label":"Sort",className:"button icon",floating:!0,options:u.map(e.options,r=>({...r,onClick:()=>m(r)})),ref:l,trigger:n.jsx(n.Fragment,{}),value:e.value})]})};_.__docgenInfo={description:"",methods:[],displayName:"SortSelector",props:{defaultValue:{required:!1,flowType:{name:"string"},description:""},direction:{required:!0,flowType:{name:"string"},description:""},onChange:{required:!0,flowType:{name:"signature",type:"function",raw:"(sort: Sort) => void",signature:{arguments:[{name:"sort",type:{name:"intersection",raw:`Option & {
  direction?: string
  ...
  value: string,
  text: string
}`,signature:{properties:[{key:"key",value:{name:"string",required:!0}},{key:"value",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}}],raw:"Array<Option>"},description:""},text:{required:!0,flowType:{name:"string"},description:""},value:{required:!0,flowType:{name:"string"},description:""}}};const Q="book",$="https://raw.githubusercontent.com/citation-style-language/locales/master/locales-en-US.xml",p={author:"author",date:"date",title:"title"},ee=[{key:p.title,value:p.title,text:v.t("BibliographyList.sort.title")},{key:p.author,value:p.author,text:v.t("BibliographyList.sort.author")},{key:p.date,value:p.date,text:v.t("BibliographyList.sort.date")}],te=X(e=>n.jsx(k,{divided:!0,relaxed:"very",children:u.map(e.items,(l,m)=>n.jsxs(k.Item,{as:x,columns:2,padded:!0,children:[n.jsx(k.Content,{as:x.Column,textAlign:"left",verticalAlign:"middle",width:14,children:n.jsx(K,{item:l,locale:e.locale,style:e.style&&e.style.xml})}),n.jsx(k.Content,{as:x.Column,textAlign:"right",verticalAlign:"middle",width:2,children:u.map(e.actions,(r,i)=>n.jsx(j,{"aria-label":r.name,basic:!0,icon:r.icon,onClick:r.onClick.bind(void 0,l)},i))})]},m))})),E=e=>{const[l,m]=a.useState(),[r,i]=a.useState(!1),[o,c]=a.useState(),[s,q]=a.useState({}),y=a.useCallback(t=>{const{id:d}=t||{},{uid:g=Y()}=t||{},f=u.omit(t,"id","uid","data");return u.extend(f,{creators:u.reject(t.creators,T=>!(T.name||T.firstName||T.lastName))}),{id:d,uid:g,data:f}},[]),w=a.useCallback((t,d)=>{let g;if(s===p.title)g=t.title;else if(s===p.author){const f=u.first(t.creators);g=f?.name||`${f?.lastName}, ${f?.firstName}`}else s===p.date?g=t.date:g=d;return g},[]),D=a.useMemo(()=>{let t=u.chain(e.items).filter(d=>!d._destroy).map(d=>({...u.omit(d,"data"),...d.data})).value();return t=u.sortBy(t,w),s.direction===P&&(t=t.reverse()),t},[w,s,e.items]),N=a.useCallback(()=>n.jsxs(n.Fragment,{children:[n.jsx(J,{onChange:(t,d)=>c({name:t,xml:d})}),n.jsx(_,{direction:s.direction,onChange:t=>q(t),options:ee,text:s.text,value:s.value})]}),[s,o]),U=a.useCallback(t=>Promise.resolve(e.onDelete(y(t))),[y,e.onDelete]),L=a.useCallback(t=>Promise.resolve(e.onSave(y(t))),[y,e.onSave]);return a.useEffect(()=>{fetch($).then(t=>t.text()).then(t=>m(t))},[]),n.jsx(Z.Provider,{value:{translateUrl:e.translateUrl},children:n.jsxs("div",{children:[n.jsx(W,{onError:()=>i(!0),onFind:t=>u.map(t,L)}),n.jsx(te,{...e,actions:[{name:"edit"},{name:"delete"}],className:"bibliography-list",items:D,locale:l,modal:{component:B,props:{defaults:{itemType:Q}}},onDelete:U,onSave:L,renderListHeader:N,style:o}),r&&n.jsx(A,{onDismiss:()=>i(!1),timeout:2500,type:A.MessageTypes.warning,children:n.jsx(G.Header,{content:v.t("Common.messages.noResults")})})]})})};E.__docgenInfo={description:"This component renders a list of bibliography items in Zbib format. This component requires the URL of a running\n[Zotero Translation Server](https://github.com/zotero/translation-server) to be passed as the `translateUrl` prop.",methods:[],displayName:"BibliographyList",props:{actions:{required:!1,flowType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
The consuming component is responsible for tracking the selected items.`},showRecordCount:{required:!1,flowType:{name:"boolean"},description:"If <code>true</code>, the total number of records will display in the list header."},items:{required:!0,flowType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  uid?: string,
  data: any
}`,signature:{properties:[{key:"id",value:{name:"number",required:!1}},{key:"uid",value:{name:"string",required:!1}},{key:"data",value:{name:"any",required:!0}}]}}],raw:"Array<Item>"},description:"The array of bibliography items."},translateUrl:{required:!0,flowType:{name:"string"},description:"URL of the Zotero translation server."}}};const ht={title:"Components/Semantic UI/BibliographyList",component:E},b=()=>{const[e,l]=a.useState([{id:1,uid:"A",data:{itemType:"book",title:"First Test",creators:[{creatorType:"author",nameType:1,firstName:"Author",lastName:"Test"}]}},{id:2,uid:"B",data:{itemType:"book",title:"Second test"}}]),m=a.useCallback(i=>l(o=>C.filter(o,c=>c.uid!==i.uid)),[]),r=a.useCallback(i=>{const o=C.findWhere(e,{uid:i.uid});l(o?c=>C.map(c,s=>s===o?i:s):c=>[...c,i])},[e]);return n.jsx(E,{items:e,onDelete:m,onSave:r,translateUrl:"/translate"})};b.__docgenInfo={description:"",methods:[],displayName:"Default"};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`() => {
...
}`,...b.parameters?.docs?.source}}};const bt=["Default"];export{b as Default,bt as __namedExportsOrder,ht as default};
