import{j as e}from"./jsx-runtime-D9TvR9R2.js";import"./index-C0dDX-lL.js";import{c}from"./clsx-B-dksMZM.js";import{I as B}from"./Icon-BiV3qc2F.js";import{A as O}from"./AccordionItemsList-Coms3s6s.js";import{R as E}from"./RecordDetailHeader-BGFJ0vzX.js";import{R as G}from"./RecordDetailBreadcrumbs-CvvFFDec.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-BGIGw4h8.js";import"./extends-CCbyfPlC.js";import"./index-CIyLsbPd.js";import"./index-DOYXiIEK.js";import"./index-BmSdlTVd.js";import"./index-CMZE9jPC.js";import"./index-default-C_maRo4o.js";import"./Button-BVnVN7dx.js";import"./RecordDetailTitle-BWKKhIbt.js";import"./RecordDetailItem-4ThsbstP.js";import"./i18n-O47xwIR-.js";import"./i18next-CwS9wMM1.js";import"./toPropertyKey-BcUJYDQU.js";import"./defineProperty-DcNpp85p.js";import"./inherits-CWPG5jll.js";import"./assertThisInitialized-B9jnkVVz.js";import"./setPrototypeOf-DgZC2w_0.js";import"./createClass-CV9nCQMI.js";import"./getPrototypeOf-BYVhAdwF.js";const M=t=>{var m,p,f,v,h;return e.jsxs("div",{className:c("relative","shadow-[0px_5px_12px_0px_rgba(0,0,0,.10)]","overflow-y-auto",(m=t.classNames)==null?void 0:m.root),children:[e.jsxs("div",{className:"sticky inset-0 shadow-[0px_1px_4px_0px_rgba(0,0,0,.15)] bg-white z-[5]",children:[t.onClose&&e.jsx("div",{onClick:t.onClose,onKeyDown:t.onClose,tabIndex:"0",role:"button","aria-label":"Close",className:"absolute top-6 right-6 z-10 cursor-pointer",children:e.jsx(B,{name:"close",size:24})}),(t.breadcrumbs||t.onGoBack)&&e.jsx(G,{history:t.breadcrumbs||[],onGoBack:t.onGoBack,className:"absolute top-6 left-6 pr-6 max-w-[calc(100%_-4.5em)] z-10"}),e.jsx(E,{title:t.title,icon:t.icon,classNames:{root:c({"!pt-16":t.breadcrumbs||t.onGoBack},(p=t.classNames)==null?void 0:p.header),title:c((f=t.classNames)==null?void 0:f.title,{"pr-6":t.onClose}),items:(v=t.classNames)==null?void 0:v.items},detailItems:t.detailItems,detailPageUrl:t.detailPageUrl,children:t.children})]}),e.jsx(O,{className:c("shadow-[0px_1px_4px_rgba(0,0,0,.15)]",(h=t.classNames)==null?void 0:h.relatedRecords),items:t.relations,count:t.count})]})},i=M;M.__docgenInfo={description:"",methods:[],displayName:"RecordDetailPanel",props:{breadcrumbs:{required:!1,flowType:{name:"Array",elements:[{name:"string"}],raw:"Array<string>"},description:"A list of navigation breadcrumbs to be rendered above the title"},children:{required:!1,flowType:{name:"Node"},description:"Content to be rendered as the blurb"},classNames:{required:!1,flowType:{name:"signature",type:"object",raw:"{ header?: string, items?: string, relatedRecords?: string, root?: string, title?: string }",signature:{properties:[{key:"header",value:{name:"string",required:!1}},{key:"items",value:{name:"string",required:!1}},{key:"relatedRecords",value:{name:"string",required:!1}},{key:"root",value:{name:"string",required:!1}},{key:"title",value:{name:"string",required:!1}}]}},description:`Class names to apply to the root div, the header box, the title element,
the list element containing the detail items, and the accordion list containing related records`},count:{required:!1,flowType:{name:"Boolean"},description:"If true, the number of related records will be displayed for each type"},detailItems:{required:!1,flowType:{name:"Array",elements:[{name:"signature",type:"object",raw:"{ text: string, icon?: string, className?: string }",signature:{properties:[{key:"text",value:{name:"string",required:!0}},{key:"icon",value:{name:"string",required:!1}},{key:"className",value:{name:"string",required:!1}}]}}],raw:"Array<{ text: string, icon?: string, className?: string }>"},description:"List of detail fields to be rendered above the blurb"},detailPageUrl:{required:!1,flowType:{name:"string"},description:"If a URL for a record detail page is provided, will render a button that links to it"},icon:{required:!1,flowType:{name:"string"},description:"The icon to display before the header."},onClose:{required:!1,flowType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"A function called when the `close` icon is clicked"},onGoBack:{required:!1,flowType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"A function called when the back arrow is clicked"},relations:{required:!1,flowType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  */
  ...
  </RecordDetailPanel>`,...(y=(b=n.parameters)==null?void 0:b.docs)==null?void 0:y.source}}};var x,k,j;r.parameters={...r.parameters,docs:{...(x=r.parameters)==null?void 0:x.docs,source:{originalSource:`() => <RecordDetailPanel relations={sampleData} detailPageUrl='#' title='West Tokyo Qualifiers Quarterfinal' detailItems={[{
  text: 'July 27',
  icon: 'date'
}, {
  text: 'Meiji Jinju Stadium',
  ...
  </RecordDetailPanel>`,...(j=(k=r.parameters)==null?void 0:k.docs)==null?void 0:j.source}}};var N,q,w;s.parameters={...s.parameters,docs:{...(N=s.parameters)==null?void 0:N.docs,source:{originalSource:`() => <RecordDetailPanel relations={sampleData} title='West Tokyo Qualifiers Quarterfinal' detailItems={[{
  text: 'July 27',
  icon: 'date'
}, {
  text: 'Meiji Jinju Stadium',
  ...
  </RecordDetailPanel>`,...(w=(q=s.parameters)==null?void 0:q.docs)==null?void 0:w.source}}};var T,A,W;o.parameters={...o.parameters,docs:{...(T=o.parameters)==null?void 0:T.docs,source:{originalSource:`() => <RecordDetailPanel relations={sampleData} title='West Tokyo Qualifiers Quarterfinal' detailItems={[{
  text: 'July 27',
  icon: 'date'
}, {
  text: 'Meiji Jinju Stadium',
  ...
  </RecordDetailPanel>`,...(W=(A=o.parameters)==null?void 0:A.docs)==null?void 0:W.source}}};var I,Q,R;l.parameters={...l.parameters,docs:{...(I=l.parameters)==null?void 0:I.docs,source:{originalSource:`() => <RecordDetailPanel relations={sampleData} title='West Tokyo Qualifiers Quarterfinal' detailItems={[{
  text: 'July 27',
  icon: 'date'
}, {
  text: 'Meiji Jinju Stadium',
  ...
  </RecordDetailPanel>`,...(R=(Q=l.parameters)==null?void 0:Q.docs)==null?void 0:R.source}}};var S,D,J;u.parameters={...u.parameters,docs:{...(S=u.parameters)==null?void 0:S.docs,source:{originalSource:`() => <RecordDetailPanel relations={sampleData} title='West Tokyo Qualifiers Quarterfinal' detailItems={[{
  text: 'July 27',
  icon: 'date'
}, {
  text: 'Meiji Jinju Stadium',
  ...
  </RecordDetailPanel>`,...(J=(D=u.parameters)==null?void 0:D.docs)==null?void 0:J.source}}};var C,P,_;d.parameters={...d.parameters,docs:{...(C=d.parameters)==null?void 0:C.docs,source:{originalSource:`() => <RecordDetailPanel relations={sampleData} title='West Tokyo Qualifiers Quarterfinal' count detailItems={[{
  text: 'July 27',
  icon: 'date'
}, {
  text: 'Meiji Jinju Stadium',
  ...
  </RecordDetailPanel>`,...(_=(P=d.parameters)==null?void 0:P.docs)==null?void 0:_.source}}};const ge=["Default","WithViewDetail","WithIcon","WithClose","WithBreadcrumbs","FixedWidthAndHeight","WithCounts"];export{n as Default,u as FixedWidthAndHeight,l as WithBreadcrumbs,o as WithClose,d as WithCounts,s as WithIcon,r as WithViewDetail,ge as __namedExportsOrder,he as default};
