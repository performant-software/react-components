import{j as o}from"./iframe-CDKtSUh7.js";import{I as i}from"./Icon-5o84n6La.js";import{L as s}from"./Label-CH_WshmF.js";import{_ as c}from"./index-default-C0I3bBxV.js";import"./extends-CCbyfPlC.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./getElementType-0Tp31rtT.js";import"./ModernAutoControlledComponent-B-ilQLgm.js";import"./assertThisInitialized-B9jnkVVz.js";import"./includes-DtwzgLcn.js";import"./toFinite-DjjXQZ2l.js";import"./forEach-Dp4nfTUu.js";import"./Dimmer-DQCDOJdA.js";import"./Portal-DdFmWNdd.js";import"./keyboardKey-BIrml5XW.js";const t=e=>o.jsx("div",{className:"tags-list",children:c.map(e.tags||[],n=>o.jsxs(s,{style:{backgroundColor:e.config&&e.config[n]&&e.config[n].background,color:e.config&&e.config[n]&&e.config[n].color,marginRight:"10px"},children:[n,e.onDelete&&o.jsx(i,{name:"delete",onClick:e.onDelete.bind(void 0,n)})]}))});t.__docgenInfo={description:"",methods:[],displayName:"TagsList",props:{config:{required:!1,flowType:{name:"signature",type:"object",raw:`{
  [key: string]: {
    background: string,
    color: string
  }
