import{r as a,j as n}from"./iframe-DT7QbYH7.js";import{_ as C}from"./index-default-B8-H6N8J.js";import{r as h,d as M,i as R,e as F,p as O}from"./index.es28-DplMxnFD.js";import{G as x}from"./Grid-DnSsNey7.js";import{M as $}from"./Message-BWHOEKG4.js";import{B as j}from"./Button-NSPqHwS_.js";import{L as k}from"./List-Y4xJFSjw.js";import{_ as u}from"./index-default-C0I3bBxV.js";import{F as G}from"./Form-BQyRKPEr.js";import{M as S}from"./Modal-BLWOqSD2.js";import{i as v}from"./i18n-DkobdbHY.js";import{B as H}from"./BibliographyForm-AGcFrJsw.js";import{Z as V,B as Z}from"./BibliographySearchInput-CcR0CPZQ.js";import{D as W}from"./Dropdown-B06UXL3V.js";import{S as z}from"./StyleSelector-BkMC5Ggm.js";import{T as A}from"./Toaster-D8B4RmUP.js";import{u as J}from"./List-DN2zyirj.js";import{v as X}from"./v4-BKrj-4V8.js";import"./extends-CCbyfPlC.js";import"./getElementType-D9Dm3kUn.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./Icon-ey9jiNEy.js";import"./map-CN2A-66k.js";import"./Label-BiRn_-_3.js";import"./ModernAutoControlledComponent-Cz85Fsnf.js";import"./assertThisInitialized-B9jnkVVz.js";import"./includes-DlRNvmPY.js";import"./toFinite-EWrCJB8-.js";import"./forEach-CUQnNrTW.js";import"./Dimmer-C1tpBS2T.js";import"./Portal-Dqo72CYe.js";import"./keyboardKey-8QW-HgB9.js";import"./Checkbox-BruMkqRI.js";import"./_baseSet-DYVjP9W1.js";import"./_baseAssignValue-DsBxPc0Q.js";import"./Input-EBrwWnz0.js";import"./index-bnJZsReu.js";import"./_arrayReduce-CrxnWFSq.js";import"./isEmpty-ChjRJg2c.js";import"./index-BQRsQj70.js";import"./i18next-eNuDfwAU.js";import"./Bibliography-DhQmFg_f.js";import"./without-CmhwM1cQ.js";import"./isArrayLikeObject-PvVLkR8c.js";import"./deburr-C41nhHE6.js";import"./filter-COQqCgju.js";import"./Transition-BCar87ro.js";import"./Confirm-Bcq_WzdR.js";import"./Pagination-ec1geT5J.js";import"./_isIterateeCall-BRjCcuaA.js";import"./Menu-BtFKFQvB.js";import"./Header-CEjFUjA0.js";import"./DropdownButton-DMPXDpaZ.js";import"./EditModal-DrtrKd4l.js";import"./index.es3-Ccj8FELR.js";import"./index.es33-DjWGJBwf.js";import"./Loader-Bd5kBuZ-.js";import"./index.es24-BxCSri79.js";import"./AssociatedDropdown-UwoM9Rf8.js";import"./index.es35-NGGuPWEW.js";import"./FuzzyDate-BHxjqZgO.js";import"./DateInput-Jstzj3FY.js";import"./Trans-Ds7eWJHh.js";import"./context-DS3FtK-6.js";const Y=e=>{const[l,m]=a.useState(),r=a.useCallback(i=>{const o={...i};return h.isEmpty(o.title)&&h.isEmpty(o.creators)&&h.isEmpty(o.issue)&&h.extend(o,{title:M.t("Citation.labels.untitled")}),o},[]);return a.useEffect(()=>{if(e.locale&&e.style&&e.item){const{uid:i,...o}=e.item,c=new F({initialItems:[{key:i,...r(o)}],persist:!1}),s=h.first(c.itemsCSL),q={retrieveLocale:()=>e.locale,retrieveItem:()=>s},y=new O.Engine(q,e.style);y.updateItems([s.id]);const w=y.makeBibliography();m(h.last(w))}},[r,e.item,e.locale,e.style]),R.jsx("div",{dangerouslySetInnerHTML:{__html:l}})},B=e=>n.jsxs(S,{as:G,centered:!1,open:!0,children:[n.jsx(S.Header,{content:v.t("BibliographyModal.title")}),n.jsx(S.Content,{children:n.jsx(H,{...e})}),e.children]});B.__docgenInfo={description:"",methods:[],displayName:"BibliographyModal",props:{item:{required:!0,flowType:{name:"any"},description:""}}};const I="ascending",P="descending",_=e=>{const l=a.useRef(),m=a.useCallback(r=>{const i=e.value===r.value&&e.direction===I?P:I;e.onChange({...r,direction:i})},[e.direction,e.onChange,e.value]);return a.useEffect(()=>{if(!e.value){let r;e.defaultValue?r=u.findWhere(e.options,{value:e.defaultValue}):r=u.first(e.options),m(r)}},[]),n.jsxs(j.Group,{basic:!0,className:"sort-selector",style:{fontSize:"inherit"},children:[n.jsx(j,{"aria-label":"Sort by",content:e.text,icon:e.direction===I?"sort alphabet up":"sort alphabet down",onClick:r=>l.current.handleClick(r)}),n.jsx(W,{"aria-label":"Sort",className:"button icon",floating:!0,options:u.map(e.options,r=>({...r,onClick:()=>m(r)})),ref:l,trigger:n.jsx(n.Fragment,{}),value:e.value})]})};_.__docgenInfo={description:"",methods:[],displayName:"SortSelector",props:{defaultValue:{required:!1,flowType:{name:"string"},description:""},direction:{required:!0,flowType:{name:"string"},description:""},onChange:{required:!0,flowType:{name:"signature",type:"function",raw:"(sort: Sort) => void",signature:{arguments:[{name:"sort",type:{name:"intersection",raw:`Option & {
  direction?: string
...
The consuming component is responsible for tracking the selected items.`},showRecordCount:{required:!1,flowType:{name:"boolean"},description:"If <code>true</code>, the total number of records will display in the list header."},items:{required:!0,flowType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  uid?: string,
  data: any
}`,signature:{properties:[{key:"id",value:{name:"number",required:!1}},{key:"uid",value:{name:"string",required:!1}},{key:"data",value:{name:"any",required:!0}}]}}],raw:"Array<Item>"},description:"The array of bibliography items."},translateUrl:{required:!0,flowType:{name:"string"},description:"URL of the Zotero translation server."}}};const pt={title:"Components/Semantic UI/BibliographyList",component:E},b=()=>{const[e,l]=a.useState([{id:1,uid:"A",data:{itemType:"book",title:"First Test",creators:[{creatorType:"author",nameType:1,firstName:"Author",lastName:"Test"}]}},{id:2,uid:"B",data:{itemType:"book",title:"Second test"}}]),m=a.useCallback(i=>l(o=>C.filter(o,c=>c.uid!==i.uid)),[]),r=a.useCallback(i=>{const o=C.findWhere(e,{uid:i.uid});l(o?c=>C.map(c,s=>s===o?i:s):c=>[...c,i])},[e]);return n.jsx(E,{items:e,onDelete:m,onSave:r,translateUrl:"/translate"})};b.__docgenInfo={description:"",methods:[],displayName:"Default"};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`() => {
...
}`,...b.parameters?.docs?.source}}};const yt=["Default"];export{b as Default,yt as __namedExportsOrder,pt as default};
