import{j as n}from"./jsx-runtime-D9TvR9R2.js";import{$ as m,a as p,b as c,c as f,d as u}from"./index-BGIGw4h8.js";import{c as i}from"./clsx-B-dksMZM.js";import"./index-C0dDX-lL.js";import{_ as a}from"./index-default-C_maRo4o.js";import{I as o}from"./Icon-xn5eBWjd.js";const s=r=>n.jsx(m,{className:i("accordion-items-list",r.className),type:"multiple",children:a.map(r.items,(e,l)=>n.jsxs(p,{value:e.title,children:[n.jsx(c,{asChild:!0,children:n.jsx("h2",{children:n.jsxs(f,{className:"accordion-list-trigger border-neutral-100 border border-t border-b-0 border-l-0 border-r-0 border-solid rounded-none w-full flex justify-between items-center p-4 text-[15px] font-bold leading-[120%]",children:[e.renderTitle?e.renderTitle(e.title,e.count):n.jsxs("span",{children:[e.title,r.count?n.jsxs("span",{className:"ml-2",children:["(",e.items.length,")"]}):null]}),n.jsx(o,{className:"accordion-list-chevron",name:"right",size:18})]})})}),n.jsx(u,{className:"accordion-list-content text-[13px] font-semibold leading-[120%]",children:n.jsx("ul",{className:i({flex:e.horizontal},{"flex-row":e.horizontal},{"flex-wrap":e.horizontal},{"gap-6":e.horizontal},{"py-6":e.horizontal}),children:a.map(e.items,(t,d)=>n.jsx(n.Fragment,{children:e.renderItem?e.renderItem(t):n.jsxs("li",{onClick:t.onClick,onKeyDown:t.onClick,tabIndex:t.onClick?"0":"-1",className:i("flex flex-row gap-2 items-baseline px-6 py-2",{"hover:bg-neutral-100":t.onClick,"cursor-pointer":t.onClick}),children:[e.icon&&n.jsx(o,{name:e.icon,size:14}),n.jsx("span",{children:t.name})]},d)}))})})]},l))}),w=s;s.__docgenInfo={description:"This component renders the passed list of related items in an accordion fashion.",methods:[],displayName:"AccordionItemsList",props:{className:{required:!1,flowType:{name:"string"},description:"Optional list of classes to be applied to the root element"},count:{required:!1,flowType:{name:"Boolean"},description:"If true, will display the number of items in each section after the title"},items:{required:!0,flowType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  /**
