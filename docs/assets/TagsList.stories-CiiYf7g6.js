import{j as o}from"./iframe-D2tDQHIu.js";import{I as i}from"./Icon-BSWzGvLf.js";import{L as s}from"./Label-CmMRyCgB.js";import{_ as c}from"./index-default-C0I3bBxV.js";import"./extends-CCbyfPlC.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./getElementType-TLbMidFA.js";import"./ModernAutoControlledComponent-CIi-16Zs.js";import"./assertThisInitialized-B9jnkVVz.js";import"./includes-ComNSsGh.js";import"./toFinite-Ch3-mxAi.js";import"./forEach-xROvcHNC.js";import"./Dimmer-Wnz_k9oJ.js";import"./Portal-BF3g11_x.js";import"./keyboardKey-UPAJnvsN.js";const t=e=>o.jsx("div",{className:"tags-list",children:c.map(e.tags||[],n=>o.jsxs(s,{style:{backgroundColor:e.config&&e.config[n]&&e.config[n].background,color:e.config&&e.config[n]&&e.config[n].color,marginRight:"10px"},children:[n,e.onDelete&&o.jsx(i,{name:"delete",onClick:e.onDelete.bind(void 0,n)})]}))});t.__docgenInfo={description:"",methods:[],displayName:"TagsList",props:{config:{required:!1,flowType:{name:"signature",type:"object",raw:`{
  [key: string]: {
    background: string,
    color: string
  }
