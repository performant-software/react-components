import{r as a,j as n}from"./iframe-Dh9sgUpq.js";import{_ as C}from"./index-default-B8-H6N8J.js";import{r as h,d as M,i as R,e as F,p as O}from"./index.es28-ClGGhP_v.js";import{G as x}from"./Grid-Cnt1NUOG.js";import{M as $}from"./Message-CUhF5y31.js";import{B as j}from"./Button-BW5bPNnW.js";import{L as k}from"./List-CDYxk2xz.js";import{_ as u}from"./index-default-C0I3bBxV.js";import{F as G}from"./Form-DcHmKAQR.js";import{M as S}from"./Modal-DQE8eeAm.js";import{i as v}from"./i18n-C0aeT7bv.js";import{B as H}from"./BibliographyForm-DZNuuzVu.js";import{Z as V,B as Z}from"./BibliographySearchInput-BYVEqhS3.js";import{D as W}from"./Dropdown-Bj4Xrag2.js";import{S as z}from"./StyleSelector-CAUCzS8k.js";import{T as A}from"./Toaster-nMLKIfxU.js";import{u as J}from"./List-D8moVCUb.js";import{v as X}from"./v4-BKrj-4V8.js";import"./extends-CCbyfPlC.js";import"./getElementType-BOa7Z56o.js";import"./_getPrototype-dFVwFHqx.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./Icon-lekhSa4x.js";import"./map-Ccqzkkhu.js";import"./Label-Bo6azEc2.js";import"./ModernAutoControlledComponent-DR2uLhLR.js";import"./assertThisInitialized-B9jnkVVz.js";import"./includes-BYxib7lt.js";import"./toFinite-Dfj0KU41.js";import"./toNumber-DIkYOhwr.js";import"./forEach--q4dx8jk.js";import"./_arrayEach-DpGxo2Of.js";import"./Dimmer-B48fuewG.js";import"./Portal-BfO7jr1_.js";import"./keyboardKey-CGp_nnHN.js";import"./Checkbox-BhijoQRF.js";import"./_baseSet-S7wwy84w.js";import"./_assignValue-wlBxhqFj.js";import"./_baseAssignValue-yJv1-bft.js";import"./Input-_0vGTYtM.js";import"./index-B5RqLgX3.js";import"./_arrayReduce-CrxnWFSq.js";import"./isEmpty-CIv_nSFx.js";import"./index-Dt36bpg4.js";import"./i18next-eNuDfwAU.js";import"./Bibliography-Bnm0obHl.js";import"./without-H_YsQImY.js";import"./isArrayLikeObject-DSLl7ti9.js";import"./deburr-BCxeCCWq.js";import"./isEqual-mHuJTF3G.js";import"./filter-stojC0mR.js";import"./Transition-CgTdmYTt.js";import"./Confirm-BPTa23vu.js";import"./Pagination-DkjD1lbR.js";import"./_isIterateeCall-CnbN5PRK.js";import"./Menu-CQRUjdLj.js";import"./Header-QePrEz-3.js";import"./DropdownButton-5gep3f4-.js";import"./EditModal-BzAkpom0.js";import"./index.es3-hocMhY6t.js";import"./index.es33-1CWRrp_9.js";import"./Loader-D41Zlcvy.js";import"./index.es24-BxCSri79.js";import"./AssociatedDropdown-x1dx2z4j.js";import"./index.es35-NGGuPWEW.js";import"./FuzzyDate-DGnk_ZQt.js";import"./DateInput-ByMqYSyw.js";import"./Trans-DHwrf0IR.js";import"./context-DFN-mYo8.js";const Y=e=>{const[l,m]=a.useState(),r=a.useCallback(i=>{const o={...i};return h.isEmpty(o.title)&&h.isEmpty(o.creators)&&h.isEmpty(o.issue)&&h.extend(o,{title:M.t("Citation.labels.untitled")}),o},[]);return a.useEffect(()=>{if(e.locale&&e.style&&e.item){const{uid:i,...o}=e.item,c=new F({initialItems:[{key:i,...r(o)}],persist:!1}),s=h.first(c.itemsCSL),q={retrieveLocale:()=>e.locale,retrieveItem:()=>s},y=new O.Engine(q,e.style);y.updateItems([s.id]);const w=y.makeBibliography();m(h.last(w))}},[r,e.item,e.locale,e.style]),R.jsx("div",{dangerouslySetInnerHTML:{__html:l}})},B=e=>n.jsxs(S,{as:G,centered:!1,open:!0,children:[n.jsx(S.Header,{content:v.t("BibliographyModal.title")}),n.jsx(S.Content,{children:n.jsx(H,{...e})}),e.children]});B.__docgenInfo={description:"",methods:[],displayName:"BibliographyModal",props:{item:{required:!0,flowType:{name:"any"},description:""}}};const I="ascending",P="descending",_=e=>{const l=a.useRef(),m=a.useCallback(r=>{const i=e.value===r.value&&e.direction===I?P:I;e.onChange({...r,direction:i})},[e.direction,e.onChange,e.value]);return a.useEffect(()=>{if(!e.value){let r;e.defaultValue?r=u.findWhere(e.options,{value:e.defaultValue}):r=u.first(e.options),m(r)}},[]),n.jsxs(j.Group,{basic:!0,className:"sort-selector",style:{fontSize:"inherit"},children:[n.jsx(j,{"aria-label":"Sort by",content:e.text,icon:e.direction===I?"sort alphabet up":"sort alphabet down",onClick:r=>l.current.handleClick(r)}),n.jsx(W,{"aria-label":"Sort",className:"button icon",floating:!0,options:u.map(e.options,r=>({...r,onClick:()=>m(r)})),ref:l,trigger:n.jsx(n.Fragment,{}),value:e.value})]})};_.__docgenInfo={description:"",methods:[],displayName:"SortSelector",props:{defaultValue:{required:!1,flowType:{name:"string"},description:""},direction:{required:!0,flowType:{name:"string"},description:""},onChange:{required:!0,flowType:{name:"signature",type:"function",raw:"(sort: Sort) => void",signature:{arguments:[{name:"sort",type:{name:"intersection",raw:`Option & {
  direction?: string
...
The consuming component is responsible for tracking the selected items.`},showRecordCount:{required:!1,flowType:{name:"boolean"},description:"If <code>true</code>, the total number of records will display in the list header."},items:{required:!0,flowType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  uid?: string,
  data: any
}`,signature:{properties:[{key:"id",value:{name:"number",required:!1}},{key:"uid",value:{name:"string",required:!1}},{key:"data",value:{name:"any",required:!0}}]}}],raw:"Array<Item>"},description:"The array of bibliography items."},translateUrl:{required:!0,flowType:{name:"string"},description:"URL of the Zotero translation server."}}};const bt={title:"Components/Semantic UI/BibliographyList",component:E},b=()=>{const[e,l]=a.useState([{id:1,uid:"A",data:{itemType:"book",title:"First Test",creators:[{creatorType:"author",nameType:1,firstName:"Author",lastName:"Test"}]}},{id:2,uid:"B",data:{itemType:"book",title:"Second test"}}]),m=a.useCallback(i=>l(o=>C.filter(o,c=>c.uid!==i.uid)),[]),r=a.useCallback(i=>{const o=C.findWhere(e,{uid:i.uid});l(o?c=>C.map(c,s=>s===o?i:s):c=>[...c,i])},[e]);return n.jsx(E,{items:e,onDelete:m,onSave:r,translateUrl:"/translate"})};b.__docgenInfo={description:"",methods:[],displayName:"Default"};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`() => {
...
}`,...b.parameters?.docs?.source}}};const vt=["Default"];export{b as Default,vt as __namedExportsOrder,bt as default};
